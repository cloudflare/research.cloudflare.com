...
related_interests:
  - cryptography
pillar: safe
metaDescription: "First adaptively secure constrained PRFs from standard assumptions in the standard model, including t-CNF predicates from OWFs, inner-product predicates from LWE, and all circuits from LWE and IO."
---
