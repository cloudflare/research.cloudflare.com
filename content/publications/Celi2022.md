...
related_interests:
  - cryptography
pillar: safe
metaDescription: "Computer-verified symbolic analyses of KEMTLS and KEMTLS-PDK using two distinct Tamarin models, demonstrating same security properties as TLS 1.3 with fully automated proofs."
---
