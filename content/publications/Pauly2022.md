...
related_interests:
  ...
  - protocols
pillar: fast
metaDescription: "IETF extension allowing TLS clients to request specific numbers of session tickets during handshake, enabling optimized connection resumption for different use cases."
---
