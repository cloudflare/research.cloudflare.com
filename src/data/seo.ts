export const linkDescriptions = Object.freeze({
  ...
  reliable:
    "Access publications and insights on internet reliability, distributed architecture, and the foundational protocols of a dependable global network.",
  measurable:
    "Access publications and insights on internet measurement, verifiable systems, and the open standards ensuring a more transparent web.",
});
