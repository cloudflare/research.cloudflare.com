...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center px-4 py-2 text-lg font-medium disabled:pointer-events-none disabled:opacity-50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1",
);
...
function NavigationMenuTrigger({ className, children, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Trigger>) {
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      {...props}
    >
      {children} <Icon id="chevronUpDown" className="text-baby-blue-eyes" size={20} />
    </NavigationMenuPrimitive.Trigger>
  );
}
