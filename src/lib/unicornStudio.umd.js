!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(["exports"], t)
      : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).UnicornStudio = {}));
})(this, function (e) {
  "use strict";
  ...
  let h = class {
    constructor(e) {
      if (((this.type = "Scene"), e && "Renderer" === e.type)) {
        if (!e.gl) return void a(this.type + ": Renderer WebGL context is undefined", e);
      } else a(this.type + ": Renderer not passed as first argument", e);
    ...
    addToRenderTargetsStack(e) {
      ...
      ((s = Math.max(0, s)),
        t.splice(s, 0, e),
        e.target._depth
          ? (t.sort((e, t) => e.index - t.index), t.sort((e, t) => t.renderOrder - e.renderOrder))
          : (t.sort((e, t) => t.index - e.index), t.sort((e, t) => e.renderOrder - t.renderOrder)),
        t.sort((e, t) => e.target.index - t.target.index),
        (this.stacks.renderTargets = t));
    }
    addToRegularPlaneStack(e) {
      const t = this.renderer.planes.filter(
        (t) => "PingPongPlane" !== t.type && !t.target && t._transparent === e._transparent && t.uuid !== e.uuid,
      );
      let s = -1;
      for (let i = t.length - 1; i >= 0; i--)
    ...
    addPlane(e) {
      if ("PingPongPlane" === e.type) this.stacks.pingPong.push(e);
        ...
        (t.sort((e, t) => t.relativeTranslation.z - e.relativeTranslation.z),
          t.sort((e, t) => t.renderOrder - e.renderOrder),
    ...
    setPlaneRenderOrder(e) {
      ...
      if (e.target)
        (e.target._depth
          ? (this.stacks.renderTargets.sort((e, t) => e.index - t.index),
            this.stacks.renderTargets.sort((e, t) => t.renderOrder - e.renderOrder))
          : (this.stacks.renderTargets.sort((e, t) => t.index - e.index),
            this.stacks.renderTargets.sort((e, t) => e.renderOrder - t.renderOrder)),
          this.stacks.renderTargets.sort((e, t) => e.target.index - t.target.index));
      else {
        ...
        !this.renderer.depth || s
          ? (t.sort((e, t) => t.index - e.index),
            e._transparent && t.sort((e, t) => e.relativeTranslation.z - t.relativeTranslation.z),
            t.sort((e, t) => e.renderOrder - t.renderOrder))
          : (t.sort((e, t) => e.index - t.index),
            e._transparent && t.sort((e, t) => t.relativeTranslation.z - e.relativeTranslation.z),
            t.sort((e, t) => t.renderOrder - e.renderOrder));
      }
    }
    addShaderPass(e) {
  ...
  class u {
    ...
    contextLost(e) {
      ((this.state.isContextLost = !0),
        this.state.isActive && (e.preventDefault(), this.nextRender.add(() => this.onContextLost && this.onContextLost())));
    }
    restoreContext() {
      this.state.isActive &&
        (this.initState(),
        this.gl && this.extensions.WEBGL_lose_context
          ...
          : (this.gl || this.production
              ? this.extensions.WEBGL_lose_context ||
                this.production ||
                r(this.type + ": Could not restore the context because the restore context extension is not defined")
    ...
    useProgram(e) {
      (null !== this.state.currentProgramID && this.state.currentProgramID === e.id) ||
  ...
  class p {
        ...
        if ("string" == typeof e)
          if ((e = document.getElementById(e))) this.container = e;
            ...
            (e.setAttribute("id", "curtains-canvas"),
              ...
              (this.container = e),
              this.production ||
                r('Curtains: no valid container HTML element or ID provided, created a div with "curtains-canvas" ID instead'));
          }
    ...
    _addListeners() {
      ((this._resizeHandler = null),
        this._autoResize &&
          ((this._resizeHandler = this.resize.bind(this, !0)), window.addEventListener("resize", this._resizeHandler, !1)));
    }
    setPixelRatio(e, t) {
    ...
    handleUniformSetting(e) {
      switch (e.type) {
        ...
        case "mat4":
          ...
          break;
        default:
          this.renderer.production || r(this.type + ": This uniform type is not handled : ", e.type);
      }
    }
    setInternalFormat(e) {
      "Vec2" === e.value.type
                      ...
                      ? 4 === t.value.length
                        ? ((t.type = "4f"),
                          this.renderer.production ||
                            r(this.type + ": No uniform type declared for " + t.name + ", applied a 4f (array of 4 floats) uniform type"))
                        : 3 === t.value.length
                          ? ((t.type = "3f"),
                            this.renderer.production ||
                              r(this.type + ": No uniform type declared for " + t.name + ", applied a 3f (array of 3 floats) uniform type"))
                          : 2 === t.value.length &&
                            ((t.type = "2f"),
                            this.renderer.production ||
                              r(this.type + ": No uniform type declared for " + t.name + ", applied a 2f (array of 2 floats) uniform type"))
                      : "mat" === t._internalFormat
                        ? 16 === t.value.length
                          ? ((t.type = "mat4"),
                            this.renderer.production ||
                              r(
                                this.type + ": No uniform type declared for " + t.name + ", applied a mat4 (4x4 matrix array) uniform type",
                              ))
                          : 9 === t.value.length
                            ? ((t.type = "mat3"),
                              this.renderer.production ||
                        ...
                        : ((t.type = "1f"),
                          this.renderer.production ||
                            r(this.type + ": No uniform type declared for " + t.name + ", applied a 1f (float) uniform type"))),
    ...
    updateUniforms() {
      if (this.uniforms)
        for (const e in this.uniforms) {
          ...
          let s = !1;
          ("Vec2" === t._internalFormat || "Vec3" === t._internalFormat || "Quat" === t._internalFormat
  ...
  class T {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      ((this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = "Plane" === this.parent.type ? x : y),
        (this.defaultFsCode = "Plane" === this.parent.type ? v : b),
        s
          ? (this.vsCode = s)
          : (this.renderer.production ||
        ...
        i
          ? (this.fsCode = i)
          : (this.renderer.production || r(this.parent.type + ": No fragment shader provided, will use a default one"),
    ...
    createShader(e, t) {
      ...
      if (
        ...
        return (
          ...
          a(i),
          r(this.type + ": Will use a default", e),
    ...
    createProgram() {
      if (
        ...
        return (
          r(this.type + ": Unable to initialize the shader program: " + this.gl.getProgramInfoLog(this.program)),
      ...
      if (
        (this.gl.deleteShader(this.vertexShader), this.gl.deleteShader(this.fragmentShader), !this.activeUniforms || !this.activeAttributes)
      ) {
        this.activeUniforms = { textures: [], textureMatrices: [] };
        const e = this.gl.getProgramParameter(this.program, this.gl.ACTIVE_UNIFORMS);
        for (let s = 0; s < e; s++) {
          const e = this.gl.getActiveUniform(this.program, s);
          (e.type === this.gl.SAMPLER_2D && this.activeUniforms.textures.push(e.name),
            e.type === this.gl.FLOAT_MAT4 &&
              "uMVMatrix" !== e.name &&
              "uPMatrix" !== e.name &&
              this.activeUniforms.textureMatrices.push(e.name));
        }
        this.activeAttributes = [];
        const t = this.gl.getProgramParameter(this.program, this.gl.ACTIVE_ATTRIBUTES);
        for (let s = 0; s < t; s++) {
          const e = this.gl.getActiveAttrib(this.program, s);
          this.activeAttributes.push(e.name);
        }
      }
    }
    createUniforms(e) {
      ((this.uniformsManager = new m(this.renderer, this.program, e)), this.setUniforms());
    }
    setUniforms() {
      ...
      for (let s = 0; s < this.definition.height; s++) {
        ...
        for (let s = 0; s < this.definition.width; s++) {
          ...
          (t.push(r),
            ...
            e.push(2 * (i - 0.5)),
            e.push(0),
            t.push(r + 1 / this.definition.width),
            t.push(i),
            t.push(0),
            e.push(2 * (r + 1 / this.definition.width - 0.5)),
            e.push(2 * (i - 0.5)),
            e.push(0),
            t.push(r),
            ...
            t.push(0),
            e.push(2 * (r - 0.5)),
            e.push(2 * (i + 1 / this.definition.height - 0.5)),
            e.push(0),
            t.push(r),
            t.push(i + 1 / this.definition.height),
            t.push(0),
  ...
  class R {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = O),
        (r[11] = 0),
        (r[12] = e.x + w - (M * w + F * R + D * E)),
        (r[13] = e.y + R - (S * w + k * R + I * E)),
        (r[14] = e.z + E - (C * w + A * R + O * E)),
        (r[15] = 1),
        this
      );
    }
  ...
  class M {
    ...
    clone() {
      return new M(this._x, this._y, this._z);
    }
    sanitizeNaNValuesWith(e) {
      return (
    ...
    applyQuat(e) {
      const t = this._x,
        ...
        u = -r * t - a * s - n * i;
      return (
        (this._x = h * o + u * -r + l * -n - d * -a),
        (this._y = l * o + u * -a + d * -r - h * -n),
        (this._z = d * o + u * -n + h * -a - l * -r),
        this
      );
    }
    project(e) {
  ...
  class k {
    constructor(
      ...
      if (((this.type = "Texture"), (e = (e && e.renderer) || e) && "Renderer" === e.type)) {
        if (!e.gl)
          return void (
            e.production || a(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined")
          );
      } else a(this.type + ": Renderer not passed as first argument", e);
      if (
        ((this.renderer = e),
        ...
        return ((this._copyOnInit = !0), void (this._copiedFrom = s));
    ...
    _restoreContext() {
      if (
        ...
        (this._initTexture(),
          ...
          this.source &&
            (this.setSource(this.source), "image" === this.sourceType ? this.renderer.cache.addTexture(this) : this.needUpdate()),
          (this._canDraw = !0));
    }
    addParent(e) {
      !e || ("Plane" !== e.type && "PingPongPlane" !== e.type && "ShaderPass" !== e.type && "RenderTarget" !== e.type)
        ? this.renderer.production || r(this.type + ": cannot add texture as a child of ", e, " because it is not a valid parent")
    ...
    _setParent() {
      if (
        ...
        if (!this._parent._program.compiled)
          return void (this.renderer.production || r(this.type + ": Unable to create the texture because the program is not valid"));
    ...
    _setTextureUniforms() {
      ...
      for (let t = 0; t < e.textures.length; t++)
        if (e.textures[t] === this._sampler.name) {
          ...
          (e.textureMatrices.find((e) => e === this._textureMatrix.name) &&
    ...
    setSource(e) {
      ...
      const t = "IMG" === e.tagName.toUpperCase() ? "image" : e.tagName.toLowerCase();
      if ((("video" !== t && "canvas" !== t) || (this._useCache = !1), this._useCache)) {
      ...
      if ("empty" === this.sourceType || this.sourceType !== t)
        if ("video" === t) ((this._willUpdate = !1), (this.shouldUpdate = !0));
        else if ("canvas" === t) ((this._willUpdate = !0), (this.shouldUpdate = !0));
        else {
          if ("image" !== t)
            return void (this.renderer.production || r(this.type + ": this HTML tag could not be converted into a texture:", e.tagName));
      ...
      ((this.source = e),
        ...
        "image" === this.sourceType &&
          ((this.parameters.generateMipmap = this.parameters.generateMipmap || null === this.parameters.generateMipmap),
      ...
      (this.renderer.state.unpackAlignment !== this._globalParameters.unpackAlignment &&
        ...
        "half-float" === this._globalParameters.floatingPoint
          ? this.renderer._isWebGL2 && this.renderer.extensions.EXT_color_buffer_float
            ? ((this._globalParameters.internalFormat = this.gl.RGBA16F), (this._globalParameters.type = this.gl.HALF_FLOAT))
            : this.renderer.extensions.OES_texture_half_float
              ...
              : this.renderer.production || r(this.type + ": could not use half-float textures because the extension is not available")
          : "float" === this._globalParameters.floatingPoint &&
            (this.renderer._isWebGL2 && this.renderer.extensions.EXT_color_buffer_float
              ? ((this._globalParameters.internalFormat = this.gl.RGBA16F), (this._globalParameters.type = this.gl.FLOAT))
              : this.renderer.extensions.OES_texture_float
                ...
                : this.renderer.production || r(this.type + ": could not use float textures because the extension is not available")));
    }
    _updateTexParameters() {
      (this.index && this.renderer.state.activeTexture !== this.index && this._bindTexture(),
        this.parameters.wrapS !== this._state.wrapS &&
          (this.renderer._isWebGL2 || (o(this._size.width) && o(this._size.height)) || (this.parameters.wrapS = this.gl.CLAMP_TO_EDGE),
        ...
        this.parameters.wrapT !== this._state.wrapT &&
          (this.renderer._isWebGL2 || (o(this._size.width) && o(this._size.height)) || (this.parameters.wrapT = this.gl.CLAMP_TO_EDGE),
        ...
        this.parameters.generateMipmap &&
          ...
          this.source &&
          (this.renderer._isWebGL2 || (o(this._size.width) && o(this._size.height))
        ...
        this.parameters.minFilter !== this._state.minFilter &&
          (this.renderer._isWebGL2 || (o(this._size.width) && o(this._size.height)) || (this.parameters.minFilter = this.gl.LINEAR),
        ...
        this.parameters.magFilter !== this._state.magFilter &&
          (this.renderer._isWebGL2 || (o(this._size.width) && o(this._size.height)) || (this.parameters.magFilter = this.gl.LINEAR),
    ...
    _upload() {
      (this._updateGlobalTexParameters(),
        ...
        this._uploaded ||
          (this.renderer.nextRender.add(() => this._onSourceUploadedCallback && this._onSourceUploadedCallback()), (this._uploaded = !0)));
    }
    _getSizes() {
      ...
      const e = this._parent.scale ? S.set(this._parent.scale.x, this._parent.scale.y) : S.set(1, 1),
      ...
      let o = 0,
        h = 0;
      return (
        n > a ? (h = Math.min(0, s - t * (1 / a))) : n < a && (o = Math.min(0, t - s * a)),
        {
          parentWidth: t,
          parentHeight: s,
          sourceWidth: i,
    ...
    setScale(e) {
      e.type && "Vec2" === e.type
        ? (e.sanitizeNaNValuesWith(this.scale).max(S.set(0.001, 0.001)), e.equals(this.scale) || (this.scale.copy(e), this.resize()))
        : this.renderer.production || r(this.type + ": Cannot set scale because the parameter passed is not of Vec2 type:", e);
    }
    setOffset(e) {
      e.type && "Vec2" === e.type
        ? (e.sanitizeNaNValuesWith(this.offset), e.equals(this.offset) || (this.offset.copy(e), this.resize()))
        : this.renderer.production || r(this.type + ": Cannot set offset because the parameter passed is not of Vec2 type:", scale);
    }
    _setSize() {
    ...
    _updateTextureMatrix(e) {
      const t = C.set(e.parentWidth / (e.parentWidth - e.xOffset), e.parentHeight / (e.parentHeight - e.yOffset), 1);
      ((t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = F.setFromArray([
          t.x,
          0,
          0,
          0,
    ...
    _draw() {
      (this._sampler.isActive &&
        ...
        "video" === this.sourceType &&
          ...
          !this.source.paused &&
          (this._willUpdate = !0),
        (this._forceUpdate || (this._willUpdate && this.shouldUpdate)) && ((this._state.generateMipmap = !1), this._upload()),
    ...
    _dispose(e = !1) {
      var t;
      ("video" === this.sourceType || ("image" === this.sourceType && !this.renderer.state.isActive)
        ? (this._loader && this._loader._removeSource(this), (this.source = null))
        : "canvas" === this.sourceType &&
          this.source &&
          ((this.source.width = null == (t = this.source) ? void 0 : t.width), (this.source = null)),
        (this._parent = null));
      this.gl &&
        !this._copiedFrom &&
        (e || "image" !== this.sourceType || !this.renderer.state.isActive) &&
        ((this._canDraw = !1),
  ...
  class A {
    ...
    _getSourceType(e) {
      ...
      return (
        "string" == typeof e
          ? null !== e.match(/\.(jpeg|jpg|jfif|pjpeg|pjp|gif|bmp|png|webp|svg|avif|apng)$/)
            ? (t = "image")
            : null !== e.match(/\.(webm|mp4|mpg|mpeg|avi|ogg|ogm|ogv|mov|av1)$/) && (t = "video")
    ...
    _createImage(e) {
      if ("string" != typeof e && e.hasAttribute("crossOrigin")) return e;
      {
        ...
        return (
          ...
          "string" == typeof e
            ? (t.src = e)
            : ((t.src = e.src), e.hasAttribute("data-sampler") && t.setAttribute("data-sampler", e.getAttribute("data-sampler"))),
          t
        );
      }
    }
    ...
    loadImage(e, t = {}, s, i) {
      ...
      if ((this._parent && (a = Object.assign(a, this._parent._texturesOptions)), (a.loader = this), r)) {
        ((a.sampler = "string" != typeof e && e.hasAttribute("data-sampler") ? e.getAttribute("data-sampler") : a.sampler),
          (a.fromTexture = r));
        const t = new k(this.renderer, a);
      ...
      const o = new k(this.renderer, a),
        h = this._addElement(n, o, s, i);
      (n.complete
        ...
        : n.decode
          ? n
              ...
              .catch(() => {
                (n.addEventListener("load", h.load, !1), n.addEventListener("error", h.error, !1));
              })
          : (n.addEventListener("load", h.load, !1), n.addEventListener("error", h.error, !1)),
    ...
    loadVideo(e, t = {}, s, i) {
      ...
      (r.addEventListener("canplaythrough", o.load, !1),
        ...
        "requestVideoFrameCallback" in HTMLVideoElement.prototype &&
          ...
          (n._videoFrameCallbackID = r.requestVideoFrameCallback(o.videoFrameCallback))));
    }
    loadVideos(e, t, s, i) {
    ...
    _removeSource(e) {
      ...
      t &&
        ("image" === e.sourceType
          ...
          : "video" === e.sourceType &&
            (t.videoFrameCallback && e._videoFrameCallbackID && t.source.cancelVideoFrameCallback(e._videoFrameCallbackID),
  ...
  class D extends A {
    constructor(e, t, { sourcesLoaded: s = 0, sourcesToLoad: i = 0, complete: a = !1, onComplete: n = () => {} } = {}) {
    ...
    _setLoaderSize(e) {
      ((this.sourcesToLoad = e),
        0 === this.sourcesToLoad && ((this.complete = !0), this.renderer.nextRender.add(() => this.onComplete && this.onComplete())));
    }
    _increment() {
      (this.sourcesLoaded++,
  ...
  class I {
    constructor(
      ...
      if (
        ((this.type = t),
        ((e = (e && e.renderer) || e) && "Renderer" === e.type) ||
          (a(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e),
          setTimeout(() => {
        ...
        return (
          this.renderer.production ||
            a(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"),
          void setTimeout(() => {
            this._onErrorCallback && this._onErrorCallback();
          }, 0)
        );
      ((this._canDraw = !1),
        ...
        (h = parseInt(h)),
        (l = parseInt(l)),
        (this._geometry = new w(this.renderer, { width: h, height: l })),
        (this._program = new T(this.renderer, {
          parent: this,
          vertexShader: r,
          fragmentShader: n,
        })),
    ...
    _initMesh() {
      ((this.uuid = n()),
        (this.loader = new D(this.renderer, this, {
          sourcesLoaded: 0,
          initSourcesToLoad: 0,
          complete: !1,
          onComplete: () => {
    ...
    setRenderTarget(e) {
      e && "RenderTarget" === e.type
        ...
        : this.renderer.production ||
          r(this.type + ": Could not set the render target because the argument passed is not a RenderTarget class object", e);
    }
    setRenderOrder(e = 0) {
      (e = isNaN(e) ? this.renderOrder : parseInt(e)) !== this.renderOrder &&
        ((this.renderOrder = e), this.renderer.scene.setPlaneRenderOrder(this));
    }
    createTexture(e = {}) {
      const t = new k(this.renderer, Object.assign(e, this._texturesOptions));
      return (t.addParent(this), t);
    }
    addTexture(e) {
      e && "Texture" === e.type
        ? e.addParent(this)
        : this.renderer.production || r(this.type + ": cannot add ", e, " to this " + this.type + " because it is not a valid texture");
    }
    loadSources(e, t = {}, s, i) {
      for (let r = 0; r < e.length; r++) this.loadSource(e[r], t, s, i);
    }
    loadSource(e, t = {}, s, i) {
      this.loader.loadSource(
        ...
        (e, t) => {
          (this.renderer.production || r(this.type + ": this HTML tag could not be converted into a texture:", e.tagName), i && i(e, t));
        },
      );
    }
    loadImage(e, t = {}, s, i) {
      this.loader.loadImage(
        ...
        (e, t) => {
          (this.renderer.production || r(this.type + ": There has been an error:\n", t, "\nwhile loading this image:\n", e), i && i(e, t));
        },
      );
    }
    loadVideo(e, t = {}, s, i) {
    ...
    playVideos() {
      for (let e = 0; e < this.textures.length; e++) {
        ...
        if ("video" === t.sourceType) {
          ...
          void 0 !== e &&
            e.catch((e) => {
              this.renderer.production || r(this.type + ": Could not play the video : ", e);
            });
        }
      }
    }
    ...
    _dispose() {
      if (this.gl) {
        (this._geometry && this._geometry.dispose(),
          this.target && "ShaderPass" === this.type && (this.renderer.removeRenderTarget(this.target), this.textures.shift()));
  ...
  class L extends I {
    constructor(
      ...
      (super(e, s, {
        ...
        cullFace: h,
        uniforms: l,
        vertexShaderID: (d = d || (t && t.getAttribute("data-vs-id"))),
        fragmentShaderID: (u = u || (t && t.getAttribute("data-fs-id"))),
        vertexShader: c,
        fragmentShader: p,
        texturesOptions: m,
        crossOrigin: g,
        ...
        this.gl &&
          ...
          (this.htmlElement && 0 !== this.htmlElement.length) ||
            this.renderer.production ||
            r(this.type + ": The HTML element you specified does not currently exists in the DOM"),
    ...
    resize() {
      (this._setDocumentSizes(),
        "Plane" === this.type &&
          (this.setPerspective(this.camera.fov, this.camera.near, this.camera.far), this._setWorldSizes(), this._applyWorldPositions()));
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : z.set(1, 1),
        s = O.set(
      ...
      return O.set(((e.x - n) / i) * 2 - 1, 1 - ((e.y - a) / r) * 2);
    }
    onAfterResize(e) {
      return (e && (this._onAfterResizeCallback = e), this);
    }
  ...
  class U {
    ...
    setFov(e) {
      ((e = isNaN(e) ? this.fov : parseFloat(e)),
        (e = Math.max(1, Math.min(e, 179))) !== this.fov && ((this.fov = e), this.setPosition(), (this._shouldUpdate = !0)),
        this.setCSSPerspective());
    }
    setNear(e) {
      ((e = isNaN(e) ? this.near : parseFloat(e)), (e = Math.max(e, 0.01)) !== this.near && ((this.near = e), (this._shouldUpdate = !0)));
    }
    setFar(e) {
    ...
    setCSSPerspective() {
      this.CSSPerspective =
        Math.pow(Math.pow(this.width / (2 * this.pixelRatio), 2) + Math.pow(this.height / (2 * this.pixelRatio), 2), 0.5) /
    ...
    updateProjectionMatrix() {
      ...
      this.projectionMatrix.setFromArray([o, 0, 0, 0, 0, h, 0, 0, l, d, u, -1, 0, 0, c, 0]);
    }
    forceUpdate() {
  ...
  class V {
    ...
    setFromVec3(e) {
      ...
      return (
        "XYZ" === this.axisOrder
          ? ((this.elements[0] = o * a * n + r * h * l),
            (this.elements[1] = r * h * n - o * a * l),
            (this.elements[2] = r * a * l + o * h * n),
            (this.elements[3] = r * a * n - o * h * l))
          : "YXZ" === this.axisOrder
            ? ((this.elements[0] = o * a * n + r * h * l),
              (this.elements[1] = r * h * n - o * a * l),
              (this.elements[2] = r * a * l - o * h * n),
  ...
  class se extends L {
    ...
    _initTransformValues() {
      ((this.rotation = new M()),
        ...
        (this.quaternion = new V()),
        (this.relativeTranslation = new M()),
        this.relativeTranslation.onChange(() => this._setTranslation()),
        (this._translation = new M()),
        (this.scale = new M(1)),
        this.scale.onChange(() => {
          ((this.scale.z = 1), this._applyScale());
        }),
        (this.transformOrigin = new M(0.5, 0.5, 0)),
    ...
    setPerspective(e, t, s) {
      (this.camera.setPerspective(e, t, s, this.renderer._boundingRect.width, this.renderer._boundingRect.height, this.renderer.pixelRatio),
    ...
    _setWorldTransformOrigin() {
      this._boundingRect.world.transformOrigin = new M(
        (2 * this.transformOrigin.x - 1) * this._boundingRect.world.width,
        -(2 * this.transformOrigin.y - 1) * this._boundingRect.world.height,
    ...
    _setWorldPosition() {
      ...
      ((this._boundingRect.world.top = ((i - t) / this.renderer._boundingRect.height) * this._boundingRect.world.ratios.height),
        (this._boundingRect.world.left = ((e - s) / this.renderer._boundingRect.width) * this._boundingRect.world.ratios.width));
    }
    setScale(e) {
      e.type && "Vec2" === e.type
        ? (e.sanitizeNaNValuesWith(this.scale).max(B.set(0.001, 0.001)),
    ...
    setRotation(e) {
      e.type && "Vec3" === e.type
        ...
        : this.renderer.production || r(this.type + ": Cannot set rotation because the parameter passed is not of Vec3 type:", e);
    }
    _applyRotation() {
    ...
    setTransformOrigin(e) {
      e.type && "Vec3" === e.type
        ? (e.sanitizeNaNValuesWith(this.transformOrigin),
          e.equals(this.transformOrigin) || (this.transformOrigin.copy(e), this._setWorldTransformOrigin(), (this._updateMVMatrix = !0)))
        : this.renderer.production || r(this.type + ": Cannot set transform origin because the parameter passed is not of Vec3 type:", e);
    }
    _setTranslation() {
      let e = N.set(0, 0, 0);
    ...
    setRelativeTranslation(e) {
      e.type && "Vec3" === e.type
        ...
        : this.renderer.production || r(this.type + ": Cannot set translation because the parameter passed is not of Vec3 type:", e);
    }
    ...
    _getNearPlaneIntersections(e, t, s) {
      ...
      if (1 === s.length)
        0 === s[0]
          ? ((t[0] = this._getIntersection(t[1], Y.set(0.95, 1, 0).applyMat4(i))),
            t.push(this._getIntersection(t[3], q.set(-1, -0.95, 0).applyMat4(i))))
          : 1 === s[0]
            ? ((t[1] = this._getIntersection(t[0], Y.set(-0.95, 1, 0).applyMat4(i))),
              t.push(this._getIntersection(t[2], q.set(1, -0.95, 0).applyMat4(i))))
            : 2 === s[0]
              ? ((t[2] = this._getIntersection(t[3], Y.set(-0.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[1], q.set(1, 0.95, 0).applyMat4(i))))
              : 3 === s[0] &&
                ((t[3] = this._getIntersection(t[2], Y.set(0.95, -1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(-1, 0.95, 0).applyMat4(i))));
      else if (2 === s.length)
        0 === s[0] && 1 === s[1]
          ? ((t[0] = this._getIntersection(t[3], Y.set(-1, -0.95, 0).applyMat4(i))),
            (t[1] = this._getIntersection(t[2], q.set(1, -0.95, 0).applyMat4(i))))
          : 1 === s[0] && 2 === s[1]
            ? ((t[1] = this._getIntersection(t[0], Y.set(-0.95, 1, 0).applyMat4(i))),
              (t[2] = this._getIntersection(t[3], q.set(-0.95, -1, 0).applyMat4(i))))
            : 2 === s[0] && 3 === s[1]
              ? ((t[2] = this._getIntersection(t[1], Y.set(1, 0.95, 0).applyMat4(i))),
                (t[3] = this._getIntersection(t[0], q.set(-1, 0.95, 0).applyMat4(i))))
              : 0 === s[0] &&
                3 === s[1] &&
                ((t[0] = this._getIntersection(t[1], Y.set(0.95, 1, 0).applyMat4(i))),
                (t[3] = this._getIntersection(t[2], q.set(0.95, -1, 0).applyMat4(i))));
      else if (3 === s.length) {
        let r = 0;
        for (let t = 0; t < e.length; t++) s.includes(t) || (r = t);
        ((t = [t[r]]),
          0 === r
            ? (t.push(this._getIntersection(t[0], Y.set(-0.95, 1, 0).applyMat4(i))),
              t.push(this._getIntersection(t[0], q.set(-1, 0.95, 0).applyMat4(i))))
            : 1 === r
              ? (t.push(this._getIntersection(t[0], Y.set(0.95, 1, 0).applyMat4(i))),
                t.push(this._getIntersection(t[0], q.set(1, 0.95, 0).applyMat4(i))))
              : 2 === r
                ...
                : 3 === r &&
                  (t.push(this._getIntersection(t[0], Y.set(-0.95, -1, 0).applyMat4(i))),
                  t.push(this._getIntersection(t[0], q.set(-1.95, 0).applyMat4(i)))));
      } else for (let r = 0; r < e.length; r++) ((t[r][0] = 1e4), (t[r][1] = 1e4));
      return t;
    }
    _getWorldCoords() {
      const e = [H.set(-1, 1, 0), G.set(1, 1, 0), j.set(1, -1, 0), X.set(-1, -1, 0)];
      let t = [],
        s = [];
      for (let o = 0; o < e.length; o++) {
        const i = e[o].applyMat4(this._matrices.modelViewProjection.matrix);
        (t.push(i), Math.abs(i.z) > 1 && s.push(o));
      }
      ...
      for (let o = 0; o < t.length; o++) {
        const e = t[o];
        (e.x < i && (i = e.x), e.x > r && (r = e.x), e.y < a && (a = e.y), e.y > n && (n = e.y));
      }
    ...
    _computeWebGLBoundingRect() {
      ...
      ((t.width = t.right - t.left),
        ...
        (this._boundingRect.worldToDocument = {
          ...
          right:
            t.left * this.renderer._boundingRect.width + this.renderer._boundingRect.left + t.width * this.renderer._boundingRect.width,
          bottom:
            t.top * this.renderer._boundingRect.height + this.renderer._boundingRect.top + t.height * this.renderer._boundingRect.height,
        }));
    }
    getWebGLBoundingRect() {
      return this._matrices.modelViewProjection
        ? ((this._boundingRect.worldToDocument && !this.alwaysDraw) || this._computeWebGLBoundingRect(), this._boundingRect.worldToDocument)
        : this._boundingRect.document;
    }
    _getWebGLDrawRect() {
      return (
    ...
    _shouldDrawCheck() {
      ...
      Math.round(e.top) >= this.renderer._boundingRect.top + this.renderer._boundingRect.height
        ? this._shouldDraw &&
          ((this._shouldDraw = !1), this.renderer.nextRender.add(() => this._onLeaveViewCallback && this._onLeaveViewCallback()))
        : (this._shouldDraw || this.renderer.nextRender.add(() => this._onReEnterViewCallback && this._onReEnterViewCallback()),
          (this._shouldDraw = !0));
    }
    isDrawn() {
    ...
    _startDrawing() {
      this._canDraw &&
        ...
        this.target
          ...
          : null === this.renderer.state.scenePassIndex && this.renderer.bindFrameBuffer(null),
        this._setPerspectiveMatrix(),
        this._setMVMatrix(),
        (this.alwaysDraw || this._shouldDraw) && this.visible && this._draw());
    }
    mouseToPlaneCoords(e) {
      if (($.setAxisOrder(this.quaternion.axisOrder), $.equals(this.quaternion) && Z.equals(this.transformOrigin)))
        return super.mouseToPlaneCoords(e);
      {
        ...
        if (Math.abs(n) >= 1e-4) {
          ...
          const h = r.dot(t.clone().sub(s)) / n;
          (a.copy(s.add(i.multiplyScalar(h))), a.applyMat4(e));
        } else a.set(1 / 0, 1 / 0, 1 / 0);
        return te.set(a.x, a.y);
      }
    }
    onReEnterView(e) {
  ...
  class ie {
    constructor(
      ...
      if (((this.type = "RenderTarget"), (e = (e && e.renderer) || e) && "Renderer" === e.type)) {
        if (!e.gl)
          return void (
            e.production || a(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined")
          );
      ...
      ((this.renderer = e),
        ...
        (this._maxSize = {
          ...
          height: o ? Math.min(this.renderer.state.maxTextureSize / 4, o) : this.renderer.state.maxTextureSize / 4,
        }),
        (this._minSize = {
          width: h * this.renderer.pixelRatio,
          height: l * this.renderer.pixelRatio,
        }),
        (d = Object.assign(
          {
    ...
    _createFrameBuffer() {
      if (((this._frameBuffer = this.gl.createFramebuffer()), this.renderer.bindFrameBuffer(this, !0), this.textures.length))
        ((this.textures[0]._parent = this), this.textures[0]._restoreContext());
      else {
        new k(this.renderer, this._texturesOptions).addParent(this);
      }
    ...
    remove() {
      this._shaderPass
        ? this.renderer.production ||
          r(
            this.type + ": You're trying to remove a RenderTarget attached to a ShaderPass. You should remove that ShaderPass instead:",
            this._shaderPass,
          )
  ...
  class re extends se {
    constructor(
      ...
      (this.renderer.scene.removePlane(this),
        ...
        this.renderer.scene.addPlane(this),
        (this.readPass = new ie(e, {
          depth: !1,
          clear: !1,
          texturesOptions: p,
        })),
        (this.writePass = new ie(e, {
          depth: !1,
          clear: !1,
          texturesOptions: p,
        })),
  ...
  let ae,
    ...
    he,
    le = !1,
    de = window.innerHeight || document.documentElement.clientHeight,
    ue = window.innerWidth || document.documentElement.clientWidth,
    ce = window.scrollY || window.pageYOffset,
    pe = 0,
    me = 0,
    ge = 0,
    fe = 0,
  ...
  function Pe(e) {
    const t = {
      ...
      easeInOutQuart: (e) => (e < 0.5 ? 8 * e ** 4 : 1 - Math.pow(-2 * e + 2, 4) / 2),
      easeInQuint: (e) => e ** 5,
      easeOutQuint: (e) => 1 - Math.pow(1 - e, 5),
      easeInOutQuint: (e) => (e < 0.5 ? 16 * e ** 5 : 1 - Math.pow(-2 * e + 2, 5) / 2),
      easeOutElastic: (e) => {
        const t = (2 * Math.PI) / 3;
        return 0 === e ? 0 : 1 === e ? 1 : Math.pow(2, -10 * e) * Math.sin((10 * e - 0.75) * t) + 1;
      },
      easeInElastic: (e) => {
        const t = (2 * Math.PI) / 3;
      ...
      easeInOutCirc: (e) => (e < 0.5 ? (1 - Math.sqrt(1 - (2 * e) ** 2)) / 2 : (Math.sqrt(1 - Math.pow(-2 * e + 2, 2)) + 1) / 2),
      ...
      easeInOutBack: (e) => {
        const t = 2.5949095;
        return e < 0.5 ? (Math.pow(2 * e, 2) * (7.189819 * e - t)) / 2 : (Math.pow(2 * e - 2, 2) * ((t + 1) * (2 * e - 2) + t) + 2) / 2;
      },
    };
  ...
  function Me(e) {
    ...
    const t = ["trackMouse", "axisTilt", "trackMouseMove", "rotationTracking", "lightTracking"].some(
        (t) => e.hasOwnProperty(t) && 0 !== e[t],
      ),
      s = e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover, ...e.states.mousemove].length > 0,
      i = ("effect" === e.layerType || e.isModel) && (e.animating || e.usesPingPong),
      r = "video" === e.type,
      a = t || s || i || r;
    return ((e.local.isDynamicCache = a), a);
  }
  function Se(e, t) {
    if (e.noTextAsHtml) return;
    if (!t) return;
    let s = "fixed" === e.widthMode ? e.width : e.width * t.offsetWidth,
      i = e.height,
      r = "fixed" === e.fontSizeMode ? e.fontSize : e.fontSize * t.offsetWidth,
      a = "fixed" === e.fontSizeMode ? e.lineHeight : e.lineHeight * r,
      n = "fixed" === e.fontSizeMode ? e.letterSpacing : e.letterSpacing * r,
      o = "fixed" === e.topMode ? e.top : e.top * t.offsetHeight,
      h = "fixed" === e.leftMode ? e.left : e.left * t.offsetWidth,
      l = Be(e.anchorPoint);
    ((h -= l.x * s), (o -= l.y * i), (o += t.offsetTop), (h += t.offsetLeft));
    const d = document.querySelector(`[data-us-text="${e.local.id}"]`),
      u = d || document.createElement("div");
    (u.setAttribute("data-us-text", e.local.id),
      (u.style.cssText = `width:${s}px;top:${o}px;left:${h}px;font-size:${r}px;line-height:${a}px;letter-spacing:${n}px;font-family:${
        e.fontFamily
      };font-weight:${e.fontWeight};text-align:${e.textAlign};position:absolute;word-break:break-word;transform:rotateZ(${Math.round(
        360 * e.rotation,
      )}deg);color:transparent;z-index:2;`),
      (u.innerText = e.textContent),
      d || t.appendChild(u));
  }
  function Ce() {
    st.filter((e) => !document.body.contains(e.element)).forEach((e) => {
  ...
  function Fe() {
    ...
    let e = st.filter((e) => !e.destroyed && e.getDynamicLayers().length > 0);
    const t = (s) => {
      let i = !1;
      (e.forEach((e) => {
        e.destroyed ||
          (e.isInView && e.initialized
            ? ((e.rendering = !0), s - (e.lastTime || 0) >= e.frameDuration && !e.paused && (e.renderFrame(), (e.lastTime = s)), (i = !0))
            : (e.rendering = !1));
      }),
        (!ge || s - ge > 64) &&
          ((ce = window.scrollY || window.pageYOffset), (me = ce - pe), (pe = ce), (ge = s), (me > 1e3 || (me < 0 && !pe && !ce)) && Ze()),
        i
          ? (!(function () {
              let e = performance.now();
              st.forEach((t) => {
                var s, i, r, a, n, o;
                if (t.isInView && (null == (i = null == (s = t.curtain) ? void 0 : s.planes) ? void 0 : i.find((e) => e.uniforms.mousePos)))
                  if (
                    (Re() && (null == (a = null == (r = t.interactivity) ? void 0 : r.mouse) ? void 0 : a.disableMobile)) ||
                    (null == (o = null == (n = t.interactivity) ? void 0 : n.mouse) ? void 0 : o.disabled)
                  );
                  else {
                    ((t.mouse.pos.y = t.mouse.movePos.y),
                      (t.mouse.pos.x = t.mouse.movePos.x),
                      (t.mouse.lastPos.x = t.mouse.pos.x),
                      (t.mouse.lastPos.y = t.mouse.pos.y));
                    let s = t.isFixed ? t.bbox.top : t.bbox.top + t.scrollY,
                      i = t.bbox.left;
                    t.mouse.page.x > i &&
                    t.mouse.page.y > s &&
                    t.mouse.page.x < t.lastBbox.width + i &&
                    t.mouse.page.y < t.lastBbox.height + s
                      ? t.mouse.enterTime || (t.mouse.enterTime = e)
                      : (t.mouse.enterTime = null);
                  }
              });
            })(),
            (oe = requestAnimationFrame(t)))
          : cancelAnimationFrame(oe));
    };
    e.length ? (oe = requestAnimationFrame(t)) : cancelAnimationFrame(oe);
  }
  function ke(e, t, s) {
    return "Vec3" === (null == e ? void 0 : e.type) && "Vec3" === (null == t ? void 0 : t.type)
      ? {
          type: "Vec3",
          x: e._x + (t._x - e._x) * s,
          y: e._y + (t._y - e._y) * s,
      ...
      : "Vec2" === (null == e ? void 0 : e.type) && "Vec2" === (null == t ? void 0 : t.type)
        ? {
            type: "Vec2",
            x: e._x + (t._x - e._x) * s,
            y: e._y + (t._y - e._y) * s,
  ...
  function Ae(e, t) {
    return ("Vec2" === e.type ? (e = new E(e._x, e._y)) : "Vec3" === e.type && (e = new M(e._x, e._y, e._z)), e);
  }
  function De(e, t, s) {
    (null == e ? void 0 : e.type) && ("Vec2" === (null == e ? void 0 : e.type) || "Vec3" === (null == e ? void 0 : e.type))
      ? ((t.value.x = e.x), (t.value.y = "pos" === s ? 1 - e.y : e.y), "Vec3" === e.type && (t.value.z = e.z))
      : (t.value = e);
  }
  function Ie(e, t, s) {
    e.createTexture({ sampler: t, premultiplyAlpha: !0, fromTexture: s });
  }
  void 0 !== document.hidden
    ? ((ae = "hidden"), (ne = "visibilitychange"))
    : void 0 !== document.msHidden
      ? ((ae = "msHidden"), (ne = "msvisibilitychange"))
      : void 0 !== document.webkitHidden && ((ae = "webkitHidden"), (ne = "webkitvisibilitychange"));
  class Oe {
    constructor({ prop: e, value: t, endValue: i, transition: r, breakpoints: a, uniformData: n, loop: o = "none", loopDelay: h = 0 }) {
      (s(this, "id", be()),
        (this.prop = e),
        (this.transition = r),
        (this.complete = !1),
        ...
        (this.uniformData = n),
        (this.value = Ae(t)),
        (this.endValue = void 0 !== i ? Ae(i || 0) : null),
        ...
        (this.loop = o),
        (this.loopDelay = h),
        (this.easeFunction = Pe(this.transition.ease)));
    }
    updateEffect(e, t) {
      if (void 0 === (e = this.endValue ?? e)) return !1;
      const s = performance.now(),
        i = s - ((this.startTime || t) + this.transition.delay);
      if (i < 0) return !1;
      if ("none" !== this.loop) {
        const t = this.transition.duration + this.loopDelay,
          r = i % t;
        if (r > this.transition.duration) return !1;
        const a = r / this.transition.duration,
          n = Math.floor(i / t);
        let o = a;
        return (
          "reverse" === this.loop && n % 2 == 1 && (o = 1 - a),
          (this.progress = this.easeFunction(o)),
          (this.lastTick = s),
          ke(this.value, e, this.progress)
        );
      }
      const r = Math.max(0, Math.min(1, i / this.transition.duration));
      return (
        (this.progress = this.easeFunction(r)),
        0 !== this.progress &&
          (r >= 1
            ? ((this.complete = !0), (this.progress = 0), e)
            : ((this.lastTick = s), !this.complete && ke(this.value, e, this.progress)))
      );
    }
    resetState() {
  ...
  class ze {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= ce), "scrollIntoView" === this.mode)) {
        const i = t + ce - de * this.offset,
          r = i + (de + s) * this.range;
        let a = (ce - i) / (r - i),
          n = Math.max(0, Math.min(1, a));
        return (
          !(void 0 !== this.lastTick && ((n = we(n, this.lastTick, 2 * this.momentum)), Math.abs(this.lastTick - n) < xe)) &&
          ((this.lastTick = n), ke(e, this.value, n))
        );
      }
      if ("whileScrolling" === this.mode) {
        let t = me * this.delta;
        return (
          this.absScrollValue && (t = Math.abs(t)),
          void 0 !== this.lastTick && ((t = we(t, this.lastTick, 2 * this.momentum)), Math.abs(t) < xe)
            ? !1
            : ((this.lastScrollPos = ce), (this.lastTick = t), ke(e, this.value, t))
        );
      }
      return !1;
    }
  ...
  class Le {
    constructor({ prop: e, value: t, transition: i, breakpoints: r, uniformData: a, triggerOnElement: n }) {
      (s(this, "id", be()),
        (this.prop = e),
        (this.transition = i),
        (this.progress = 0),
    ...
    updateEffect(e, t, s) {
      var i;
      if (void 0 === e) return !1;
      const r = null == (i = null == s ? void 0 : s.getParent) ? void 0 : i.call(s),
        a = performance.now();
      if (this.triggerOnElement && ((null == s ? void 0 : s.isElement) || (null == s ? void 0 : s.isModel) || r)) {
        let e = (r || s).isHovered();
        t = e && !this.lastEnterTime ? a : e ? this.lastEnterTime : null;
      }
      const n = null === t,
        o = (a - (n ? this.lastTick || a : t + this.transition.delay)) / this.transition.duration,
        h = Math.max(0, Math.min(1, o));
      n
        ? (this.rawProgress = Math.max(0, this.rawProgress - h))
        : (this.lastEnterTime !== t && (this.lastProgress = this.rawProgress || 0),
          (this.rawProgress = Math.min(1, this.lastProgress + h)));
      const l = this.easeFunction(this.rawProgress),
        d = Math.abs(this.progress - l) > xe;
      return (
        (this.progress = l),
        !(!t && !d) &&
          ...
          !!d && ke(e, this.value, this.progress))
      );
    }
    resetState() {
      this.progress = 0;
  ...
  class Ue {
    constructor({
      ...
      (s(this, "id", be()),
        (this.prop = e),
        (this.progress = 0),
        (this.sensitivity = i ?? 0.5),
        (this.momentum = r ?? 0.25),
        (this.delay = a ?? 0),
        (this.mode = n ?? "velocity"),
        (this.axisMode = o ?? "both"),
        (this.point = h ?? { x: 0.5, y: 0.5 }),
        (this.value = Ae(t)),
        (this.uniformData = d),
    ...
    updateEffect(e, t, s) {
      ...
      if (null !== this.lastMousePos && t) {
        const e = t.x - this.lastMousePos.x,
          s = t.y - this.lastMousePos.y;
        ((r = "x" === this.axisMode ? Math.abs(e) : "y" === this.axisMode ? Math.abs(s) : Math.sqrt(e * e + s * s)),
          r > 1e-4 && (this.lastMoveTime = i));
      }
      t && (this.lastMousePos = { x: t.x, y: t.y });
      let a = this.progress;
      if ("proximity" === this.mode) {
        if (!t) return !1;
        const e = 0.5 * ((null == s ? void 0 : s.canvasWidth) || 0),
          i = 0.5 * ((null == s ? void 0 : s.canvasHeight) || 0);
        if (!e || !i) return !1;
        const r = this.point.x * e,
          n = this.point.y * i;
        let o = t.x - r,
          h = t.y - n,
          l = Math.sqrt(e * e + i * i);
        "x" === this.axisMode ? ((h = 0), (l = e)) : "y" === this.axisMode && ((o = 0), (l = i));
        const d = Math.sqrt(o * o + h * h),
          u = 1 - Math.min(1, d / l),
          c = 1 + 4 * this.sensitivity;
        a = Math.pow(u, c);
      } else {
        (this.lastMoveTime ? i - this.lastMoveTime : 1 / 0) > this.delay
          ? (a = 0)
          : r > 0 && (a = Math.min(1, this.progress + r * (this.sensitivity / 500)));
      }
      const n = we(a, this.progress, this.momentum);
      return Math.abs(n - this.progress) < xe && n < xe
        ? 0 !== this.progress && ((this.progress = 0), ke(e, this.value, 0))
        : ((this.progress = n), ke(e, this.value, n));
    }
    resetState() {
      ((this.progress = 0), (this.lastMousePos = null), (this.lastMoveTime = null));
    }
  }
  class Ve {
    constructor(e, t, i) {
      ...
      (s(this, "local", {
        ...
        (this.breakpoints =
          ((r = e.breakpoints || []).forEach((e) => {
            var t, s;
            for (let i in e.props)
              "Vec2" === (null == (t = e.props[i]) ? void 0 : t.type)
                ? (e.props[i] = new E(e.props[i]._x, e.props[i]._y))
                : "Vec3" === (null == (s = e.props[i]) ? void 0 : s.type)
                  ? (e.props[i] = new M(e.props[i]._x, e.props[i]._y, e.props[i]._z))
                  : "object" == typeof e.props[i] && (e.props[i] = Te(e.props[i]));
          }),
          r)),
        ...
        (this.states = {
          appear: e.states && e.states.appear ? e.states.appear.map((e) => new Oe(e)) : [],
          scroll: e.states && e.states.scroll ? e.states.scroll.map((e) => new ze(e)) : [],
          hover: e.states && e.states.hover ? e.states.hover.map((e) => new Le(e)) : [],
          mousemove: e.states && e.states.mousemove ? e.states.mousemove.map((e) => new Ue(e)) : [],
        }));
    }
    state() {
      return st.find((e) => e.id === this.local.sceneId) || this.initOptions;
    }
    getIndex() {
      return this.state()
    ...
    getPlane() {
      var e, t, s;
      return null == (s = null == (t = null == (e = this.state()) ? void 0 : e.curtain) ? void 0 : t.planes)
        ? void 0
        : s.find((e) => "PingPongPlane" !== e.type && e.userData.id === this.local.id);
    }
    getPlanes() {
      var e, t, s;
      return (
        (null == (s = null == (t = null == (e = this.state()) ? void 0 : e.curtain) ? void 0 : t.planes)
          ? void 0
          : s.filter((e) => "PingPongPlane" !== e.type && e.userData.id === this.local.id)) || []
      );
    }
    getMaskedItem() {
      return !!this.mask && this.state().layers.filter((e) => !e.parentLayer)[this.getIndex() - 1];
    }
    getChildEffectItems() {
      if (this.effects && this.effects.length) {
        ...
        return this.effects.map((e) => t.find((t) => t.parentLayer === e)).filter((e) => void 0 !== e);
      }
      return [];
    }
    setBreakpointValues() {
      const e = ue,
        t = this.breakpoints.sort((e, t) => t.min - e.min),
        s = {};
      if (1 === t.length && "Desktop" === t[0].name) return;
      if (t.length >= 1 && !t.find((e) => "Desktop" === e.name)) throw new Error("Malfored breakpoint data, missing Desktop");
      for (let r = t.length - 1; r >= 0; r--) {
        const i = t[r];
        if (null === i.max || e <= i.max) for (let e in i.props) s.hasOwnProperty(e) || (s[e] = i.props[e]);
      }
      const i = this.breakpoints.find((e) => "Desktop" === e.name);
      if (i) for (let r in i.props) s.hasOwnProperty(r) || (s[r] = i.props[r]);
      for (let r in s)
        if (this.hasOwnProperty(r)) {
          let e = s[r];
          (null == e ? void 0 : e.type) ? ((this[r].x = e._x), (this[r].y = e._y), void 0 !== e._z && (this[r].z = e._z)) : (this[r] = e);
        }
    ...
    updateStateEffects() {
      ...
      if (
        (!this.states.appear.some((e) => !e.complete) &&
          ...
          !(null == (s = this.states) ? void 0 : s.mousemove.length)) ||
      ...
      (this.local.cachedBreakpoint && this.local.cachedBreakpoint === (null == (i = a.currentBreakpoint) ? void 0 : i.name)) ||
        (this.local.cachedBreakpoint = null == (r = a.currentBreakpoint) ? void 0 : r.name);
      const o = (e) => !e.breakpoints || 0 === e.breakpoints.length || e.breakpoints.find((e) => e === this.local.cachedBreakpoint);
      (a.isInView &&
        (null === this.local.createdAt && (this.local.createdAt = n),
        this.states.appear
          .filter((e) => !e.complete)
          .forEach((e) => {
            if (!o(e))
            ...
            if (!e.initialized) {
              const s = [...this.states.appear.filter((t) => t.prop === e.prop)].sort(
                (e, t) => (e.transition.delay || 0) - (t.transition.delay || 0),
              )[0];
              ((null == s ? void 0 : s.id) === e.id &&
                ((this.local.uniformUpdatesPool[e.prop] = e.value), (this.local.hasUpdates = !0), this.local.updatedProps.add(e.prop)),
                (e.initialized = !0),
                t || (e.startTime = n));
            }
            (null == a ? void 0 : a.pauseTime) && (t += Math.abs(null == a ? void 0 : a.pauseTime));
            const s = e.updateEffect(this[e.prop], t);
            (!1 !== s && ((this.local.uniformUpdatesPool[e.prop] = s), (this.local.hasUpdates = !0), this.local.updatedProps.add(e.prop)),
              this.isText &&
                e.complete &&
                this.local.stateEffectProps &&
                this.local.stateEffectProps[e.prop] &&
        ...
        this.states.hover.forEach((e) => {
          if (!o(e))
            return void (this.local.stateEffectProps && this.local.stateEffectProps[e.prop] && delete this.local.stateEffectProps[e.prop]);
          const t = e.updateEffect(this[e.prop], a.mouse.enterTime, this);
          !1 !== t && ((this.local.uniformUpdatesPool[e.prop] = t), (this.local.hasUpdates = !0), this.local.updatedProps.add(e.prop));
        }),
        this.states.scroll.forEach((e) => {
          ...
          const s = a.bbox;
          if (!s) return;
          const i = e.updateEffect(this[e.prop], {
            top: a.isFixed ? 0 : null == (t = a.bbox) ? void 0 : t.top,
            height: s.height / 2,
            isFixed: a.isFixed,
          });
          !1 !== i && ((this.local.uniformUpdatesPool[e.prop] = i), (this.local.hasUpdates = !0), this.local.updatedProps.add(e.prop));
        }),
        this.states.mousemove.forEach((e) => {
          if (!o(e))
            return void (this.local.stateEffectProps && this.local.stateEffectProps[e.prop] && delete this.local.stateEffectProps[e.prop]);
          const t = e.updateEffect(this[e.prop], a.mouse.movePos, a);
          !1 !== t && ((this.local.uniformUpdatesPool[e.prop] = t), (this.local.hasUpdates = !0), this.local.updatedProps.add(e.prop));
        }),
        this.local.hasUpdates &&
          (this.getPlanes().forEach((e) => {
            var t;
            for (let s of this.local.updatedProps) {
              const i = this.local.uniformUpdatesPool[s];
              void 0 !== i &&
                (null == (t = e.uniforms[s]) ? void 0 : t.lastValue) !== i &&
                (e.uniforms[s] && De(i, e.uniforms[s], s), this.updateStateEffectProperty(s, i));
            }
          }),
          this.isText && this.local.stateEffectProps && Object.keys(this.local.stateEffectProps).length && this.render()));
    }
  ...
  let Ne = class extends Ve {
    ...
    unpackage() {
      this.effects = Te(this.effects);
      for (let e in this)
        this[e] &&
          this[e].type &&
          ("Vec2" === this[e].type
            ? (this[e] = new E(this[e]._x, this[e]._y))
            : "Vec3" === this[e].type && (this[e] = new M(this[e]._x, this[e]._y, this[e]._z)));
      return this;
    }
    dispose() {
      (this.local.canvas && ((this.local.canvas.width = 1), (this.local.canvas.height = 1), (this.local.canvas = null)),
        this.local.ctx && (this.local.ctx = null),
        super.dispose());
    }
    box() {
      const e = Be(this.anchorPoint),
        { width: t, height: s } = this.getAbsoluteDimensions(),
        { left: i, top: r } = this.getAbsolutePosition();
      return {
        anchor: { x: i + t * (0.5 - e.x), y: r + s * (0.5 - e.y) },
        center: { x: i + t / 2, y: r + s / 2 },
        left: i,
        top: r,
        width: t,
        height: s,
    ...
    getAbsolutePosition() {
      ...
      const r = this.state(),
        a = r.canvasWidth,
        n = r.canvasHeight;
      let o = (null == (t = null == (e = this.local) ? void 0 : e.stateEffectProps) ? void 0 : t.left) ?? this.left,
        h = (null == (i = null == (s = this.local) ? void 0 : s.stateEffectProps) ? void 0 : i.top) ?? this.top,
        l = "fixed" === this.leftMode ? o : o * a,
        d = "fixed" === this.topMode ? h : h * n;
      return ((l = +l.toFixed(1)), (d = +d.toFixed(1)), { left: l, top: d });
    }
    getAbsoluteDimensions() {
      var e, t, s, i;
      const r = this.state();
      let a, n;
      const o = r.canvasWidth,
        h = r.canvasHeight;
      let l = (null == (t = null == (e = this.local) ? void 0 : e.stateEffectProps) ? void 0 : t.width) ?? this.width,
        d = (null == (i = null == (s = this.local) ? void 0 : s.stateEffectProps) ? void 0 : i.height) ?? this.height,
        u = ve.includes(this.widthMode) ? this.widthMode : ve[this.widthMode],
        c = ve.includes(this.heightMode) ? this.heightMode : ve[this.heightMode];
      return (
        "auto" !== u &&
          ((a = "fixed" === u ? l : l * o), "auto" === c && ((n = a / (this.aspectRatio || 1)), (this.height = "fixed" === u ? n : n / h))),
        "auto" !== c &&
          ((n = "fixed" === this.heightMode ? d : d * h),
          "auto" === u && ((a = n * (this.aspectRatio || 1)), (this.width = "fixed" === u ? a : a / o))),
        "text" === this.layerType && (n = this.height),
        { width: a, height: n }
      );
    }
    isHovered() {
      let { left: e, top: t, width: s, height: i } = this.box();
      const r = Be(this.anchorPoint);
      (s < 0 && (s = Math.abs(s)), i < 0 && ((t += i), (i = Math.abs(i))), (e -= r.x * s), (t -= r.y * i));
      let a = this.state().mouse.movePos;
      return 2 * a.x >= e && 2 * a.x <= e + s && 2 * a.y >= t && 2 * a.y <= t + i;
    }
  };
  class We extends Ne {
    constructor(e, t, i) {
      (super(e, t), s(this, "layerType", "shape"), s(this, "isElement", !0), s(this, "isGpuElement", !0), (this.initOptions = i));
      for (let s in e) this[s] || (this[s] = e[s]);
  ...
  class Ge extends Ne {
    constructor(e, t, i) {
      (super(e, t), s(this, "layerType", "image"), s(this, "isElement", !0), s(this, "isGpuElement", !0), (this.initOptions = i));
      for (let s in e) this[s] || (this[s] = e[s]);
      this.breakpoints.length && this.setBreakpointValues();
    }
  }
  class je extends Ve {
    constructor(e, t, i) {
      var r;
      (super(e, t, i),
        s(this, "layerType", "model"),
        s(this, "isModel", !0),
        s(this, "contextType", "webgl"),
        e.moduleRef &&
          (null == (r = null == i ? void 0 : i.modules) ? void 0 : r[e.moduleRef]) &&
          (this.moduleUrl = i.modules[e.moduleRef].url),
        ...
        (this.rotationTracking = void 0 !== e.rotationTracking ? e.rotationTracking : 0),
        (this.speed = void 0 !== e.speed ? e.speed : 0.5),
        (this.pos = new M(e.pos._x, e.pos._y, e.pos._z)),
        (this.modelUrl = e.modelUrl),
        (this.scale = e.scale),
        (this.modelRotation = new M(e.modelRotation._x, e.modelRotation._y, e.modelRotation._z)),
        ...
        (this.lightPosition = new M(e.lightPosition._x, e.lightPosition._y, e.lightPosition._z)),
        (this.materialMetalness = e.materialMetalness),
        (this.materialRoughness = e.materialRoughness),
        (this.refractScale = e.refractScale),
        (this.animationAxis = new M(e.animationAxis._x, e.animationAxis._y, e.animationAxis._z)),
        ...
        (this.colorMapPosition = e.colorMapPosition ? new E(e.colorMapPosition.x ?? 0.5, e.colorMapPosition.y ?? 0.5) : new E(0.5, 0.5)),
        ...
        (this.normalMapPosition = e.normalMapPosition
          ? new E(e.normalMapPosition.x ?? 0.5, e.normalMapPosition.y ?? 0.5)
          : new E(0.5, 0.5)),
    ...
    unpackage() {
      return (
        (this.pos = new M(this.pos._x, this.pos._y, this.pos._z)),
        (this.modelRotation = new M(this.modelRotation._x, this.modelRotation._y, this.modelRotation._z)),
        (this.lightPosition = new M(this.lightPosition._x, this.lightPosition._y, this.lightPosition._z)),
        (this.animationAxis = new M(this.animationAxis._x, this.animationAxis._y, this.animationAxis._z)),
        this
      );
    }
    async loadRenderer() {
      ...
      let t = this.moduleUrl || "https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v2.0.5/extensions/model-renderer.js";
      try {
        const s = await import(t);
        ((this.local.initialize = s.initialize),
          (this.local.loadModel = s.loadModel),
          (this.local.draw = s.draw),
          (this.local.dispose = s.dispose),
          (this.local.rendererLoaded = !0),
          requestAnimationFrame(() => {
            const t = e.curtain.renderer.gl;
            (this.local.renderTarget && !this.local.renderTarget._frameBuffer && this.local.renderTarget._initRenderTarget(),
              this.local.initialize(t, this),
    ...
    handleModelLoaded() {
      if (((this.local.modelLoaded = !0), this.local.renderTarget)) {
        let e = this.local.renderTarget.getTexture();
        this.getPlane()
          .textures.find((e) => "uTexture" === e._samplerName)
          .copy(e);
      }
      this.animating || this.renderModel();
    }
    renderModel() {
      var e, t;
      if (!this.local.rendererLoaded || !this.local.modelLoaded) return;
      const s = this.state();
      if (!s || s.destroyed || !s.curtain || !s.curtain.renderer || !s.curtain.renderer.gl) return;
      const i = s.curtain.renderer.gl;
      if (0 === i.drawingBufferWidth || 0 === i.drawingBufferHeight) return;
      if (this.animating) {
        void 0 === this.local.time && (this.local.time = 0);
        let t = (null == (e = this.local.stateEffectProps) ? void 0 : e.speed) ?? this.speed ?? 0.5;
        const i = s.fps ? 60 / s.fps : 1;
        this.local.time += t * i * 60;
      }
      if (this.environmentMapIntensity > 0) {
        const e = this.getPlane();
        if (e && !(null == (t = this.environmentMapUrl) ? void 0 : t.trim())) {
      ...
      const r = void 0 !== this.local.time ? this.local.time : performance.now();
      if (this.local.renderTarget)
        if (this.local.renderTarget._frameBuffer) {
          const e = this.local.renderTarget._frameBuffer,
            ...
            s = this.local.renderTarget._size.height;
          (i.bindFramebuffer(i.FRAMEBUFFER, e), i.viewport(0, 0, t, s));
          try {
            const e = i.getParameter(i.CURRENT_PROGRAM);
            (this.local.draw(i, r, this), e && i.useProgram(e));
          } finally {
          ...
          const e = i.getParameter(i.CURRENT_PROGRAM);
          (this.local.draw(i, r, this), e && i.useProgram(e), i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, !0));
        }
    }
    resize() {}
    cleanup() {
      (this.local.dispose && this.local.dispose(this),
        ...
        this.local.renderTarget && (this.local.renderTarget.remove(), (this.local.renderTarget = null)));
    }
    isAnimating() {
      return this.visible && (this.animating || this.trackMouse > 0 || this.rotationTracking > 0);
    }
    getProp(e) {
      var t;
      return (null == (t = this.local.stateEffectProps) ? void 0 : t[e]) ?? this[e];
    }
    isHovered() {
      ...
      const e = this.state(),
        t = e.canvasWidth,
        s = e.canvasHeight,
        i = this.local.boundingBox.min,
        r = this.local.boundingBox.max,
        a = i.x * t,
        n = i.y * s,
        o = r.x * t,
        h = r.y * s,
        l = e.mouse.movePos;
      return 2 * l.x >= a && 2 * l.x <= o && 2 * l.y >= n && 2 * l.y <= h;
    }
    dispose() {
  ...
  class Xe extends Ne {
    ...
    createLocalCanvas() {
      ...
      ((t.width = e.canvasWidth * s), (t.height = e.canvasHeight * s));
      const i = t.getContext("2d");
      (i.scale(s, s), (this.local.canvas = t), (this.local.ctx = i));
    }
    resize() {
      var e, t, s;
      const i = this.state();
      if (this.local.canvas) {
        ...
        ((this.local.canvas.width = i.canvasWidth * e), (this.local.canvas.height = i.canvasHeight * e), this.local.ctx.scale(e, e));
      }
      const r = null == (e = i.currentBreakpoint) ? void 0 : e.name;
      ((null == (s = null == (t = this.states) ? void 0 : t.appear)
        ? void 0
        : s.some((e) => !e.complete && (!e.breakpoints || 0 === e.breakpoints.length || e.breakpoints.includes(r)))) || this.render(),
        Se(this, this.state().element));
    }
    default(e) {
      return {
        fill: e.fill || ["#ffffff"],
    ...
    handleFontLoaded() {
      ...
      const e = this.state();
      (e.renderFrame && e.renderFrame(), Se(this, this.state().element));
    }
    getAbsoluteFontValues(e) {
      var t, s, i, r, a, n;
      const o = (null == (s = null == (t = this.local) ? void 0 : t.stateEffectProps) ? void 0 : s.fontSize) || this.fontSize,
        h = (null == (r = null == (i = this.local) ? void 0 : i.stateEffectProps) ? void 0 : r.lineHeight) || this.lineHeight,
        l = (null == (n = null == (a = this.local) ? void 0 : a.stateEffectProps) ? void 0 : n.letterSpacing) || this.letterSpacing,
        d = "fixed" === this.fontSizeMode ? o : o * e.canvasWidth;
      return {
        fontSize: d,
        lineHeight: "fixed" === this.fontSizeMode ? h : h * d,
        letterSpacing: "fixed" === this.fontSizeMode ? l : l * d,
      };
    }
    render() {
      var e, t, s;
      if (!(null == (e = this.local) ? void 0 : e.ctx)) return;
      let i = this.local.ctx,
        { left: r, top: a, width: n } = this.box();
      const o = Be(this.anchorPoint),
        h = (null == (s = null == (t = this.local) ? void 0 : t.stateEffectProps) ? void 0 : s.rotation) || this.rotation;
      let l = this.state(),
        d = this.height,
        u = r - o.x * n,
        c = a - o.y * d,
        p = 0,
        { fontSize: m, lineHeight: g, letterSpacing: f } = this.getAbsoluteFontValues(l),
        _ = this.fontStyle.includes("italic") ? "italic" : "normal",
        x = /^\d+$/.test(this.fontStyle) ? this.fontStyle : "400";
      (i.clearRect(0, 0, l.canvasWidth, l.canvasHeight),
        (i.font = `${_} ${x} ${m}px/${g}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
        this.isSafari || ((i.textAlign = this.textAlign), (i.letterSpacing = f + "px")));
      const v = i.measureText("m").width;
      ((n = Math.max(n, v)), i.save());
      let y = u + n / 2,
        b = c + d / 2;
      (i.translate(y, b),
        i.rotate((360 * h * Math.PI) / 180),
        i.translate(-y, -b),
        "center" === this.textAlign && (u += n / 2),
        "right" === this.textAlign && (u += n),
        (i.fillStyle = this.fill[0]));
      const P = (e, t) => {
          let s = c + g * t + g / 2 + m / 3;
          this.isSafari
            ? ((e, t, s, i, r, a, n) => {
                let o,
                  h = t.split("").reduce((s, i, a) => s + e.measureText(i).width + (a < t.length - 1 ? r : 0), 0);
                if (((o = "center" === a ? s + (n - h) / 2 - n / 2 : s), "right" === a))
                  for (let l = t.length - 1; l >= 0; l--) {
                    const s = t[l];
                    ((o -= e.measureText(s).width), e.fillText(s, o, i), l > 0 && (o -= r));
                  }
                else for (let l = 0; l < t.length; l++) (e.fillText(t[l], o, i), (o += e.measureText(t[l]).width + r));
              })(i, e, u, s, f, this.textAlign, n)
            : i.fillText(e, u, s);
        },
        T = this.textContent ? this.textContent.split("\n") : [""];
      let w = T.length;
      const R = (e, t, s) => t.split("").reduce((i, r, a) => ((i += e.measureText(r).width), a < t.length - 1 && (i += s), i), 0);
      for (let E = 0; E < w; E++) {
        let e = "",
          t = T[E].split(/(\s|\n)/);
        for (let s = 0; s < t.length; s++) {
          const r = t[s],
            a = e + r;
          if ((this.isSafari && f ? R(i, a, f) : i.measureText(a).width) > n || "\n" === r) {
            if ("" !== e)
              ((T[E] = e.trim()), s !== t.length - 1 ? (T.splice(E + 1, 0, t.slice(s).join("")), w++) : "\n" !== r && T.push(r));
            else {
              let e = r,
                a = E;
              for (; e.length > 0; ) {
                let t = "";
                for (let s = 0; s < e.length && (i.measureText(t + e[s]).width <= n || 0 == s); s++) t += e[s];
                ((e = e.slice(t.length)), (T[a] = t.trim()), e.length > 0 && (T.splice(a + 1, 0, e), a++, w++));
              }
              t.slice(s + 1).length > 0 && (T[a] += t.slice(s + 1).join(""));
            }
            break;
          }
          ((e = a), s === t.length - 1 && (T[E] = e.trim()));
        }
      }
      (T.forEach((e, t) => {
        (P(e, p), t < T.length - 1 && p++);
      }),
        i.translate(-(u + n / 2), -(c + d / 2)),
        i.restore(),
        (this.height = g * p + g));
    }
  }
  ...
  function $e(e, t, s = 50) {
    const i = t || e.getBoundingClientRect(),
      r = (i.top >= -s && i.top <= de + s) || (i.bottom >= -s && i.bottom <= de + s) || (i.top <= 0 && i.bottom >= de),
      a = (i.left >= -s && i.left <= ue + s) || (i.right >= -s && i.right <= ue + s) || (i.left <= 0 && i.right >= ue);
    return r && a;
  }
  function Ze() {
    st.filter((e) => e.getDynamicLayers().length).forEach((e) => {
      let t = e.element.getBoundingClientRect();
      if (((e.scrollY = ce), e.lastBbox)) {
        0 === Math.abs(t.top - e.lastBbox.top) && me > 0
          ? ((e.fixedCounter = (e.fixedCounter || 0) + 1), e.fixedCounter > 3 && (e.isFixed = !0))
          : (e.fixedCounter = 0);
      }
  ...
  function Qe() {
    ...
    st.filter((e) => e.getDynamicLayers().length).forEach((t) => {
      if ($e(t.element, t.bbox, 100)) {
        if (!t.isInView) {
          ((t.isInView = !0), (t.pauseTime = t.pauseTime - e));
          const s = t.element.offsetWidth > 0 && t.element.offsetHeight > 0;
          (s && t.curtain
            ? t.resize()
            : s ||
              requestAnimationFrame(() => {
                t.element.offsetWidth > 0 && t.element.offsetHeight > 0 && t.curtain && t.resize();
              }),
            !t.lazyLoad || t.initialized || t.initializing || t.initializePlanes());
        }
      } else t.isInView && ((t.isInView = !1), (t.pauseTime = e));
    });
  }
  function Je() {
    ((ce = window.scrollY || window.pageYOffset), (me = ce - pe), (pe = ce), Ze(), Qe());
    const e = st.filter((e) => e.getDynamicLayers().length),
      t = st.filter((e) => e.rendering);
    e.length && !t.length && Fe();
  }
  function Ke(e) {
    const t = st.filter((e) => e.getDynamicLayers().length),
      s = st.filter((e) => e.rendering);
    t.length && !s.length && Fe();
    const i = performance.now();
    ((!fe || i - fe > 80) && (Ze(), (fe = i)), clearTimeout(_e), (_e = setTimeout(Je, 80)), Qe());
  }
  function et(e) {
    st.filter((e) => e.isInView).forEach((e) => {
      ((e.mouse.page.x = 99999999999), (e.mouse.page.y = 99999999999), (e.mouse.enterTime = null));
    });
  }
  function tt(e) {
    let t = performance.now();
    st.filter((e) => e.isInView && e.initialized).forEach((s) => {
      let i,
        r,
        a = s.bbox;
      (Math.abs(me) > 1 &&
        t - s.lastBboxTime > 64 &&
        ((a = s.element.getBoundingClientRect()), (s.lastBbox = s.bbox), (s.bbox = a), (s.scrollY = ce), (s.lastBboxTime = t)),
        e.targetTouches ? ((i = e.targetTouches[0].pageX), (r = e.targetTouches[0].pageY)) : ((i = e.pageX), (r = e.pageY)),
        s.isFixed && ((s.scrollY = 0), (r = e.targetTouches ? e.targetTouches[0].clientY : e.clientY)));
      const n = i - a.left,
        o = r - (a.top + (s.isFixed ? 0 : s.scrollY));
      ((s.mouse.page.x = i),
        (s.mouse.page.y = r),
        (s.mouse.movePos.x = 0.5 * n),
  ...
  class it {
    constructor(e) {
      (s(this, "local", { preloadedTextures: {} }),
        s(this, "scrollY", 0),
        s(this, "paused", !1),
        s(this, "destroyed", !1),
        s(this, "lastBboxTime", 0),
        (this.id = e.id),
        (this.breakpoints = [
        ...
        (this.canvasWidth = e.width || e.element.offsetWidth || ue),
        (this.canvasHeight = e.height || e.element.offsetHeight || de),
        (this.curtain = void 0),
        ...
        (this.rendering = !1),
        (this.bbox = {}),
        (this.isFixed = e.fixed || "fixed" === window.getComputedStyle(this.element).position),
        ...
        (this.split = !1),
        (this.versionId = ""),
        e.width && e.height && ((this.element.style.width = e.width + "px"), (this.element.style.height = e.height + "px")),
        (this.bbox = this.element.getBoundingClientRect()),
        (this.lastBbox = this.bbox),
        (this.currentBreakpoint = this.breakpoints.find((e) => ue >= e.min && ue <= e.max)),
        this.createCurtains(),
        this.setCanvasScale(),
        this.curtain && (this.textureLoader = new A(this.curtain)));
    }
    preloadTextures() {
      this.layers.forEach((e) => {
        var t, s, i, r, a, n, o, h, l;
        if (e.isElement) {
          if (e.local.canvas)
            this.textureLoader.loadCanvas(
              ...
              (t) => {
                ((t.userData.hasStateEffects =
                  e.states.appear.length > 0 || e.states.scroll.length > 0 || e.states.hover.length > 0 || e.states.mousemove.length > 0),
                  (e.preloadedCanvasTexture = t));
              },
              (e) => {},
            );
          else if ("image" === e.layerType) {
            if (!e.src || e.local.sourceTexture) return;
            this.local.preloadedSourceImages = this.local.preloadedSourceImages || {};
            const t = e.src,
              s = { sampler: "uSourceImage", premultipliedAlpha: !0 },
              i = (e, t) => {
                var s, i;
                const r =
                  (null == (s = e.getPlanes)
                    ...
                    : s.call(e).find((e) => {
                      ...
                      })) || (null == (i = e.getPlane) ? void 0 : i.call(e));
                r && !r.textures.some((e) => "uSourceImage" === e._samplerName) && r.addTexture(t);
              },
              r =
                this.local.preloadedSourceImages[t] ||
                (this.local.preloadedSourceImages[t] = {
                  count: 0,
                  promise: null,
                  firstItem: null,
            ...
            (r.count++,
              r.promise ||
                ((r.firstItem = e),
                (r.promise = new Promise((e) => {
                  this.textureLoader.loadImage(
                    t,
                    s,
                    (t) => {
                      ((r.firstTexture = t), e(t));
                    },
                    () => e(null),
                  );
                }))),
              ...
              r.promise.then((a) => {
                if (!e.local.sourceTexture)
                  return r.firstItem === e && a
                    ? ((e.local.sourceTextureLoading = !1), (e.local.sourceTexture = a), (e.local.imageReady = !0), void i(e, a))
                    : void this.textureLoader.loadImage(
                        t,
                        s,
                        (t) => {
                          ((e.local.sourceTextureLoading = !1), (e.local.sourceTexture = t), (e.local.imageReady = !0), i(e, t));
                        },
                        () => {
                          e.local.sourceTextureLoading = !1;
                        },
                      );
              }));
          }
        } else if (
          (null == (t = null == e ? void 0 : e.texture) ? void 0 : t.src) ||
          (null == (i = null == (s = null == e ? void 0 : e.data) ? void 0 : s.texture) ? void 0 : i.src)
        ) {
          const t =
              (null == (r = null == e ? void 0 : e.texture) ? void 0 : r.src) ||
              (null == (n = null == (a = null == e ? void 0 : e.data) ? void 0 : a.texture) ? void 0 : n.src),
            s =
              (null == (o = null == e ? void 0 : e.texture) ? void 0 : o.sampler) ||
              (null == (l = null == (h = null == e ? void 0 : e.data) ? void 0 : h.texture) ? void 0 : l.sampler) ||
              "uTexture";
          this.local.preloadedTextures[t]
            ? this.local.preloadedTextures[t].count++
            : ((this.local.preloadedTextures[t] = { count: 1, texture: null }),
              this.textureLoader.loadImage(t, { sampler: s, premultipliedAlpha: !1 }, (e) => {
                this.local.preloadedTextures[t].texture = e;
              }));
        }
      });
    }
    ...
    destroy() {
      ...
      const s = st.findIndex((e) => e.id === this.id);
      (-1 !== s && st.splice(s, 1),
        this.layers.filter((e) => e.dispose).forEach((e) => e.dispose()),
        (this.layers = []),
        (null == (e = this.curtain) ? void 0 : e.gl) && (this.curtain.dispose(), (this.curtain = null)),
        this.element &&
          ...
          this.curtain.planes.forEach((e) => {
            (e.uniforms.resolution &&
              ...
              e.uniforms.artboardResolution &&
                ((e.uniforms.artboardResolution.value.x = this.canvasWidth), (e.uniforms.artboardResolution.value.y = this.canvasHeight)));
          })));
    }
    refresh() {
      ((this.initialized = !1),
        this.layers.forEach((e) => {
          ...
          (null == (t = e.states) || t.scroll.forEach((e) => e.resetState()),
            null == (s = e.states) ||
              s.appear.forEach((t) => {
                e[t.prop] = t.endValue ?? e.local.stateEffectProps[t.prop] ?? e[t.prop];
              }),
            e.breakpoints.length &&
              (e.setBreakpointValues(),
              e.local.bpProps &&
                Object.keys(e.local.bpProps).forEach((t) => {
                  e.getPlanes().forEach((s) => {
                    s.uniforms[t] && De(e.local.bpProps[t], s.uniforms[t], t);
                  });
                })),
    ...
    getDynamicLayers() {
      return this.layers.filter((e) => Me(e));
    }
    createCurtains() {
      ((this.curtain = new p({
    ...
    setInteractiveParams(e, t) {
      let s = { mouse: { disableMobile: !1, disabled: !1 } };
      (t &&
        t.mouse &&
        ("disableMobile" in t.mouse && (s.mouse.disableMobile = t.mouse.disableMobile),
        "disabled" in t.mouse && (s.mouse.disabled = t.mouse.disabled)),
        e &&
          e.interactivity &&
          e.interactivity.mouse &&
          ("disableMobile" in e.interactivity.mouse && (s.mouse.disableMobile = e.interactivity.mouse.disableMobile),
          "disabled" in e.interactivity.mouse && (s.mouse.disabled = e.interactivity.mouse.disabled)),
    ...
    getSplitOrderedItems() {
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          r = i && Me(i),
          a = i && i.effects && i.effects.length && i.getChildEffectItems().filter((e) => Me(e)).length;
        for (; s && !Me(s) && !r && !a; )
          (t++,
            (s = e[t]),
            s &&
    ...
    getPassPlane(e, t) {
      var s;
      return null == (s = this.curtain) ? void 0 : s.planes.find((s) => s.userData.id === e.local.id && s.userData.passIndex === t);
    }
    getRenderTargets() {
      var e;
      return null == (e = this.curtain) ? void 0 : e.renderTargets.filter((e) => e.userData.id);
    }
    getPlanes() {
      var e;
      return null == (e = this.curtain) ? void 0 : e.planes.filter((e) => "PingPongPlane" !== e.type);
    }
    getPlaneParams(e, t) {
      var s, i, r, a, n;
      let o = (null == (s = e.data) ? void 0 : s.heightSegments) || (null == (i = e.data) ? void 0 : i.widthSegments) ? 500 : 1;
      const h = {
        resolution: {
          name: "uResolution",
          type: "2f",
          value: new E(this.canvasWidth, this.canvasHeight),
        },
        mousePos: { name: "uMousePos", type: "2f", value: new E(0.5) },
      ...
      let l = e.compiledFragmentShaders[t] || e.compiledFragmentShaders[0],
        d = e.compiledVertexShaders[t] || e.compiledVertexShaders[0];
      if (
        (e.states &&
          [...e.states.appear, ...e.states.scroll, ...e.states.hover, ...e.states.mousemove].forEach((t) => {
            h[t.prop] || (t.uniformData && ((h[t.prop] = t.uniformData), (h[t.prop].value = e[t.prop])));
          }),
        null == (r = e.data) ? void 0 : r.uniforms)
      )
        for (let u in e.data.uniforms) {
          let t = e.data.uniforms[u];
          ((h[u] = e.data.uniforms[u]),
            "Vec3" === (null == (a = t.value) ? void 0 : a.type)
              ? (h[u].value = new M(t.value._x, t.value._y, t.value._z))
              : "Vec2" === (null == (n = t.value) ? void 0 : n.type)
                ? (h[u].value = new E(t.value._x, t.value._y))
                : "object" == typeof t.value && (h[u].value = Te(t.value)));
        }
      return {
        fragmentShader: l,
        vertexShader: d,
    ...
    getCompositePlaneRenderOrder(e, t, s) {
      const i = e.getChildEffectItems();
      if (0 === i.length) return s;
      const r = i[i.length - 1],
        a = t.indexOf(r);
      return -1 !== a ? a + 1 : s + i.length;
    }
    createPlane(e, t) {
      var s;
      let i, r;
      ((i = e.isElement || e.isModel ? this.getPlaneParams(e) : this.getPlaneParams(e, t ? t.index : null)), (i.watchScroll = !1));
      try {
        if (!this.curtain.container) throw new Error("Can't find scene container");
        let a =
            (null == t ? void 0 : t.downSample) || (0 === (null == t ? void 0 : t.index) && (null == (s = e.data) ? void 0 : s.downSample)),
          n = this.renderingScale;
        if (
          (a && ((n = "number" == typeof a ? a : 0.5), (n *= this.renderingScale)),
          e.userDownsample && "number" == typeof e.userDownsample && (n *= e.userDownsample),
          (r = new se(this.curtain, this.curtain.container, i)),
    ...
    createPingPongPlane(e, t) {
      var s;
      let i = this.getPlaneParams(e, 1 + ((null == t ? void 0 : t.length) || 0)),
        r = null == (s = this.curtain) ? void 0 : s.planes.find((t) => "PingPongPlane" === t.type && t.userData.id === e.local.id);
      if (!r) {
        if (((r = new re(this.curtain, this.curtain.container, i)), !r)) return;
        ((r.userData.id = e.local.id),
          (r.userData.pingpong = !0),
          r
            .onReady(() => {
              (this.setInitialEffectPlaneUniforms(r, e, null == e ? void 0 : e.getParent(), t), (r.userData.isReady = !0));
            })
            .onRender(() => {
    ...
    createEffectPlane(e, t) {
      ...
      if (!s) return;
      const i = e.getParent();
      if (!s || !s.userData || !s.textures) throw new Error("Plane not properly initialized", s);
      (t &&
        ((s.userData.passIndex = t.index),
        (s.userData.length = e.data.passes.length),
        (s.userData.needsPreviousFrame = t.needsPreviousFrame),
        Object.entries(t).forEach(([e, t]) => {
          s.uniforms[e] && (s.uniforms[e].value = t);
        })),
        this.setInitialEffectPlaneUniforms(s, e, i, t),
        s
          .onReady(() => {
            s.userData.isReady = !0;
          })
          .onRender(() => this.setEffectPlaneUniforms(s, e))
          .onAfterRender(() => {
            const t = s.userData.needsPreviousFrame;
            if (t) {
              const i = s.userData.passIndex ?? 0,
                r = e.local.previousFrameTargets || {},
                a = e.local.previousFrameInputTargets || {},
                n = "target" === t ? a[i] : s.target,
                o = r[i];
              n && o && this.blitRenderTarget(n, o);
            }
          }));
    }
    createElementPlane(e) {
      ...
      t &&
        (e.getChildEffectItems().length > 0 && this.createCompositePlane(e),
        t
          .onReady(() => {
            (this.setInitialElementPlaneUniforms(t, e), (t.userData.isReady = !0));
          })
    ...
    createCompositePlane(e) {
      ...
      if (e.data.compositeUniforms)
        for (let n in e.data.compositeUniforms) {
          let t = e.data.compositeUniforms[n];
          ((r.uniforms[n] = { ...t }),
            "Vec3" === (null == (s = t.value) ? void 0 : s.type)
              ? (r.uniforms[n].value = new M(t.value._x, t.value._y, t.value._z))
              : "Vec2" === (null == (i = t.value) ? void 0 : i.type) && (r.uniforms[n].value = new E(t.value._x, t.value._y)));
        }
      const a = new se(this.curtain, this.curtain.container, r);
      return a && a.userData
        ? ((a.textures.length = 0),
          (a.userData.id = e.local.id),
          (a.userData.isComposite = !0),
          a
            .onReady(() => {
              a.userData.isReady = !0;
            })
            .onRender(() => {
              this.setCompositePlaneUniforms(a, e);
            }),
          a)
        : null;
    }
      ...
      if (
        ...
        e.uniforms.opacity &&
          (e.uniforms.opacity.value =
            (null == (i = null == (s = t.local) ? void 0 : s.stateEffectProps) ? void 0 : i.opacity) ?? t.opacity ?? 1),
        e.uniforms.mousePos)
      ) {
        ...
        s && this.mouse.movedInView && ((e.uniforms.mousePos.value.x = s.x), (e.uniforms.mousePos.value.y = s.y));
      }
    }
    handleMediaTextures(e, t, s) {
      var i;
      if (
        ([t.texture, null == (i = t.data) ? void 0 : i.texture]
          .filter((e) => (null == e ? void 0 : e.src))
          .forEach((i) => {
            var r;
            if (null == (r = t.compiledFragmentShaders[s.passIndex ?? 0]) ? void 0 : r.includes(i.sampler)) {
              const t = this.local.preloadedTextures[i.src];
              (null == t ? void 0 : t.texture)
                ? (t.count > 1 ? (Ie(e, i.sampler, t.texture), t.count--) : e.addTexture(t.texture), (e.userData.textureLoaded = !0))
                : this.textureLoader.loadImage(i.src, { premultipliedAlpha: !1, sampler: i.sampler }, (t) => {
                    (e.addTexture(t), (e.userData.textureLoaded = !0));
                  });
            }
          }),
        "video" === t.type)
      ) {
        const s = t.src.includes(", ")
          ? (function (e) {
              ...
              return t.find((e) => e.endsWith(".webm")) || t[0];
            })(t.src)
          : t.src;
        e.loadVideo(s, { premultipliedAlpha: !0, sampler: "uVideoTexture" }, (s) => {
    ...
    handleEffectPlane(e, t, s) {
      var i;
      const r = "passIndex" in s ? this.getPassPlane(e, s.passIndex) : e.getPlane();
      if (!r) return !1;
      let a = this.getRenderTargets()[t - 1],
        n = null == (i = this.curtain) ? void 0 : i.planes.find((t) => "PingPongPlane" === t.type && t.userData.id === e.local.id),
        o = e.compiledFragmentShaders[s.passIndex ?? 0];
      if (
        (n && (null == o ? void 0 : o.includes("uPingPongTexture")) && Ie(r, "uPingPongTexture", n.getTexture()),
        a ? Ie(r, "uTexture", a.getTexture()) : Ie(r, "uTexture"),
        null == o ? void 0 : o.includes("uBgTexture"))
      ) {
        let e = this.getRenderTargets()[t - (1 + s.passIndex)];
        e && Ie(r, "uBgTexture", e.getTexture());
      }
      (s.needsPreviousFrame && Ie(r, "uPreviousFrameTexture", this.createPreviousFrameTarget(e, s, t)), this.handleMediaTextures(r, e, s));
    }
    handleModelPlane(e, t) {
      var s;
      const i = e.getPlane();
      let r = this.getRenderTargets()[t - 1];
      const a = this.layers.filter((e) => !e.parentLayer);
      let n = a[a.indexOf(e) - 1];
      (i.textures.forEach((e) => {}),
        (i.textures = []),
        e.local.renderTarget ? i.addTexture(e.local.renderTarget.getTexture()) : r ? Ie(i, "uTexture", r.getTexture()) : Ie(i, "uTexture"),
        (null == (s = null == n ? void 0 : n.local) ? void 0 : s.lastTarget)
          ? Ie(i, "uBgTexture", n.local.lastTarget.getTexture())
          : Ie(i, "uBgTexture"));
    }
    createPreviousFrameTarget(e, t, s) {
      const i = t.passIndex ?? t.index ?? 0,
        r = t.downSample || 1,
        a = this.curtain.canvas.width * r,
        n = this.curtain.canvas.height * r;
      return (
        e.local.previousFrameTargets || (e.local.previousFrameTargets = {}),
        e.local.previousFrameInputTargets || (e.local.previousFrameInputTargets = {}),
        e.local.previousFrameTargets[i] ||
          ((e.local.previousFrameTargets[i] = new ie(this.curtain, {
            depth: !1,
            clear: !1,
            maxWidth: a,
            maxHeight: n,
          })),
          (e.local.previousFrameTargets[i].userData.isPingPong = !0),
          (e.local.previousFrameTargets[i].userData.isPreviousFrame = !0)),
        "target" === t.needsPreviousFrame &&
          void 0 !== s &&
          (e.local.previousFrameInputTargets[i] = this.getRenderTargets()[s - (1 + t.passIndex)]),
        e.local.previousFrameTargets[i].getTexture()
      );
    }
    handleElementPlane(e, t) {
      ...
      if (!s) return !1;
      const i = e.getChildEffectItems(),
        r = this.layers.filter((e) => !e.parentLayer);
      let a,
        n = this.getRenderTargets()[t - 1],
        o = e.maskDepthLayer || 1,
        h = r[r.indexOf(e) - (1 + o)];
      if ((e.mask && h && (a = h.local.lastTarget), e.isGpuElement))
        return (
          "image" === e.layerType &&
            (s.textures.some((e) => "uSourceImage" === e._samplerName) ||
              (e.local.sourceTexture && (s.addTexture(e.local.sourceTexture), (e.local.imageReady = !0)))),
          void (0 === i.length && n && (Ie(s, "uBgTexture", n.getTexture()), a && e.mask && Ie(s, "uPreviousLayerTexture", a.getTexture())))
        );
      if (
        (i.length || (s.textures.length = 0),
        n && i.length ? Ie(s, "uTexture", n.getTexture()) : s && e.preloadedCanvasTexture && s.addTexture(e.preloadedCanvasTexture),
        n)
      ) {
        if (i.length) {
          let e = i.reduce((e, t) => e + t.getPlanes().length, 0);
          n = this.getRenderTargets()[t - (1 + e)];
        }
        n && (Ie(s, "uBgTexture", n.getTexture()), a && e.mask && Ie(s, "uPreviousLayerTexture", a.getTexture()));
      }
    }
    handleCompositePlane(e, t) {
      const s = e.getPlanes().find((e) => e.userData.isComposite);
      if (!s) return;
      e.getChildEffectItems();
      const i = this.layers.filter((e) => !e.parentLayer);
      let r,
        a = e.maskDepthLayer || 1,
        n = i[i.indexOf(e) - (1 + a)];
      e.mask && n && (r = n.local.lastTarget);
      const o = this.getRenderTargets()[t - 1];
      o && Ie(s, "uTexture", o.getTexture());
      const h = this.getPlanes()
          .filter((e) => e.visible)
          .sort((e, t) => e.renderOrder - t.renderOrder)
          .findIndex((t) => t.userData.id === e.local.id && !t.userData.isComposite),
        l = h > 0 ? h - 1 : -1,
        d = l >= 0 ? this.getRenderTargets()[l] : null;
      d && (Ie(s, "uBgTexture", d.getTexture()), r && e.mask && Ie(s, "uPreviousLayerTexture", r.getTexture()));
    }
    handleChildEffectPlane(e, t, s) {
      var i, r, a, n, o, h;
      const l = "passIndex" in s ? this.getPassPlane(e, s.passIndex) : e.getPlane(),
        d = e.getParent();
      if (!l || !d) return;
      let u = this.getRenderTargets()[t - 1],
        c = null == (i = this.curtain) ? void 0 : i.planes.find((t) => "PingPongPlane" === t.type && t.userData.id === e.local.id),
        p = e.compiledFragmentShaders[s.passIndex ?? 0],
        m = d.effects.filter((e) => {
          if (this.layers.find((t) => t.parentLayer === e)) return this.layers.find((t) => t.parentLayer === e);
        }),
        g = m.indexOf(e.parentLayer),
        f = m.at(-1) === m[g],
        _ = s.passIndex === s.length;
      const x = d.isGpuElement;
      if (
        (c && (null == p ? void 0 : p.includes("uPingPongTexture")) && Ie(l, "uPingPongTexture", c.getTexture()),
        null == p ? void 0 : p.includes("uBgTexture"))
      )
        if (g && s.length > 1) {
          let e = this.getRenderTargets()[t - (1 + s.length)];
          e && Ie(l, "uBgTexture", e.getTexture());
        } else if (x) {
          const e = d.getPlanes().find((e) => !e.userData.isComposite);
          Ie(l, "uBgTexture", null == (n = null == e ? void 0 : e.target) ? void 0 : n.getTexture());
        } else
          (null == (a = null == (r = d.preloadedCanvasTexture) ? void 0 : r.userData) ? void 0 : a.used)
            ? l.loadCanvas(d.local.canvas, { sampler: "uBgTexture", premultiplyAlpha: !0 }, (e) => {
                e.shouldUpdate = d.preloadedCanvasTexture.shouldUpdate;
              })
            : d.preloadedCanvasTexture && ((d.preloadedCanvasTexture._samplerName = "uBgTexture"), l.addTexture(d.preloadedCanvasTexture));
      if (u && (g || s.passIndex)) {
        if (e.isMask && (!s.length || (f && _)))
          if (!x && d.preloadedCanvasTexture) l.addTexture(d.preloadedCanvasTexture);
          else {
            const e = d.getPlanes().find((e) => !e.userData.isComposite);
            Ie(l, "uMaskTexture", null == (o = null == e ? void 0 : e.target) ? void 0 : o.getTexture());
          }
        Ie(l, "uTexture", u.getTexture());
      } else if (e.isMask)
        (f && _ && !x ? l.addTexture(d.preloadedCanvasTexture) : u ? Ie(l, "uTexture", u.getTexture()) : Ie(l, "uTexture"),
          (u = this.getRenderTargets()[t - 2]),
          u && Ie(l, "uTexture", u.getTexture()));
      else if (null == p ? void 0 : p.includes("uTexture"))
        if (x) {
          const e = d.getPlanes().find((e) => !e.userData.isComposite);
          Ie(l, "uTexture", null == (h = null == e ? void 0 : e.target) ? void 0 : h.getTexture());
        } else
          d.preloadedCanvasTexture
            ? (l.addTexture(d.preloadedCanvasTexture), d.preloadedCanvasTexture && (d.preloadedCanvasTexture.userData.used = !0))
            : Ie(l, "uTexture", u.getTexture());
      (s.needsPreviousFrame && Ie(l, "uPreviousFrameTexture", this.createPreviousFrameTarget(e, s, t)),
        "custom" === e.type && Ie(l, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(l, e, s));
    }
    createPlanes() {
      (this.getOrderedItems().forEach((e) => {
        e.getPlanes().length ||
          (e.isElement ? this.createElementPlane(e) : e.isModel ? this.createModelPlane(e) : this.createEffectPlanes(e));
      }),
    ...
    calculateRenderOrders() {
      ...
      this.layers
        ...
        .forEach((e) => {
          var s, i;
          if (e.isBackground) return void (null == (s = e.getPlane()) || s.setRenderOrder(t));
          const r = e.getPlanes().filter((e) => !e.userData.isComposite);
          (e.isGpuElement && r.forEach((e) => e.setRenderOrder(t++)),
            (null == (i = e.effects) ? void 0 : i.length) &&
              e.getChildEffectItems().forEach((e) => {
                e.getPlanes().forEach((e) => e.setRenderOrder(t++));
              }),
            e.isGpuElement || r.forEach((e) => e.setRenderOrder(t++)));
          const a = e.getPlanes().find((e) => e.userData.isComposite);
          a && a.setRenderOrder(t++);
        });
      const s = this.getPlanes()
        .filter((e) => e.visible)
        .sort((e, t) => e.renderOrder - t.renderOrder);
      (null == (e = s.at(-1)) ? void 0 : e.target) && s.at(-1).target.remove();
    }
    createModelPlane(e) {
      const t = this.createPlane(e);
      t &&
        t
          .onReady(() => {
            ...
            let s = e.userDownsample || 1,
              i = this.curtain.canvas.width * s,
              r = this.curtain.canvas.height * s;
            e.local.renderTarget ||
              ((e.local.renderTarget = new ie(this.curtain, {
                depth: !0,
                maxWidth: i,
                maxHeight: r,
                texturesOptions: { sampler: "uTexture", premultiplyAlpha: !0 },
              })),
              e.local.rendererLoaded || e.loadRenderer());
          })
          .onRender(() => {
            (this.setModelPlaneUniforms(t, e), this.curtain.gl && e.renderModel());
          });
    }
    createEffectPlanes(e) {
      const t = e.data;
      t.passes && t.passes.length
        ? (this.createEffectPlane(e, {
            index: 0,
            downSample: t.downSample,
            length: t.passes.length + 1,
            needsPreviousFrame: t.needsPreviousFrame,
          }),
          t.passes.forEach((s, i) => {
            this.createEffectPlane(e, {
              index: i + 1,
              length: t.passes.length + 1,
              downSample: s.downSample,
              needsPreviousFrame: s.needsPreviousFrame,
              [s.prop]: s.value,
            });
          }),
          e.usesPingPong && this.createPingPongPlane(e, t.passes))
        : (this.createEffectPlane(e), e.usesPingPong && this.createPingPongPlane(e));
    }
    createTextures() {
      const e = this.getPlanes().sort((e, t) => e.renderOrder - t.renderOrder),
        t = e.length;
      for (let s = 0; s < t; s++) {
        const i = e[s];
        let r = this.layers.find((e) => e.local.id === i.userData.id);
        (s < t - 1 && this.assignRenderTargetToPlane(e, s, r, i), this.handleTextures(r, s, i.userData), (r.local.lastTarget = i.target));
      }
    }
    resizeRenderTarget(e, t, s) {
      var i, r, a;
      const n = (null == (i = e._size) ? void 0 : i.width) || 0,
        o = (null == (r = e._size) ? void 0 : r.height) || 0;
      if (Math.abs(n - t) <= 1 && Math.abs(o - s) <= 1) return;
      if (
        ((e._size = { width: t, height: s }),
        (e._maxSize = { width: t, height: s }),
        (e._minSize = { width: t, height: s }),
        !e._frameBuffer)
      )
        return;
      const h = null == (a = e.textures) ? void 0 : a[0];
      if (h && !h._copiedFrom) {
        h._size = { width: t, height: s };
        const i = this.curtain.gl;
        (i.bindTexture(i.TEXTURE_2D, h._sampler.texture),
          i.texImage2D(
            i.TEXTURE_2D,
            0,
            h._globalParameters.internalFormat,
            t,
            s,
            0,
            h._globalParameters.format,
            h._globalParameters.type,
            null,
          ),
          this.curtain.renderer.bindFrameBuffer(e, !0),
          e._depth &&
            e._depthBuffer &&
            (i.bindRenderbuffer(i.RENDERBUFFER, e._depthBuffer),
            i.renderbufferStorage(i.RENDERBUFFER, i.DEPTH_COMPONENT16, t, s),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.RENDERBUFFER, e._depthBuffer)),
          this.curtain.renderer.bindFrameBuffer(null));
      }
    }
    ensureRenderTargetInitialized(e, t, s) {
      e &&
        (t && s && this.resizeRenderTarget(e, t, s),
        e._frameBuffer || (this.curtain.renderer.bindFrameBuffer(e, !0), this.curtain.renderer.bindFrameBuffer(null)));
    }
    blitRenderTarget(e, t) {
      var s, i;
      const r = (null == (s = e._size) ? void 0 : s.width) || this.curtain.canvas.width,
        a = (null == (i = e._size) ? void 0 : i.height) || this.curtain.canvas.height;
      if (
        (this.ensureRenderTargetInitialized(e, r, a),
        this.ensureRenderTargetInitialized(t, r, a),
        !(null == e ? void 0 : e._frameBuffer) || !(null == t ? void 0 : t._frameBuffer))
      )
        return;
    ...
    checkIfReady(e) {
      const t = () => {
        var s;
        let i = !1;
        const r = null == (s = this.curtain) ? void 0 : s.planes;
        if (r) {
          for (let e = 0; e < r.length; e++)
            if (!r[e].userData.isReady) {
              i = !0;
              break;
            }
    ...
    setModelPlaneUniforms(e, t) {
      var s, i;
      ((e.uniforms.resolution.value.x = this.curtain.canvas.width), (e.uniforms.resolution.value.y = this.curtain.canvas.height));
      const r = this.calculateItemMouseValues(t);
      (r && !t.local.mouse && (t.local.mouse = { x: 0.5, y: 0.5 }),
        r && ((t.local.mouse.x = r.x), (t.local.mouse.y = r.y)),
        e.uniforms.opacity &&
          (e.uniforms.opacity.value = t.local.modelLoaded
            ? ((null == (i = null == (s = t.local) ? void 0 : s.stateEffectProps) ? void 0 : i.opacity) ?? t.opacity)
            : 0));
    }
    setInitialEffectPlaneUniforms(e, t, s, i) {
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let s in e.uniforms)
          (null == (r = t.states) ? void 0 : r.scroll.some((e) => e.prop === s)) ||
            (t.local.bpProps && s in t.local.bpProps ? De(t.local.bpProps[s], e.uniforms[s], s) : s in t && De(t[s], e.uniforms[s], s));
    ...
    setInitialElementPlaneUniforms(e, t) {
      ...
      for (let i in e.uniforms)
        t.local.bpProps && i in t.local.bpProps
          ...
          : i in t && (e.uniforms[i].value = (null == (s = t.local.stateEffectProps) ? void 0 : s[i]) ?? t[i]);
    }
    ...
    calculateItemMouseValues(e) {
      ...
      return (
        this.local.mouseValuePool || (this.local.mouseValuePool = new E(0.5)),
    ...
    getMousePosWithMomentum(e, t, s) {
      let i = this.mouse.pos.x,
        ...
        n = "x" === a || "xy" === a,
        o = "y" === a || "xy" === a;
      const h = e.mouseMomentum || 0;
      let l = i / t,
        d = 1 - r / s;
      if (!h) return { x: n ? l : 0.5, y: o ? d : 0.5 };
      if (!e.local.lastMousePos) return ((e.local.lastMousePos = { x: n ? l : 0.5, y: o ? d : 0.5 }), e.local.lastMousePos);
      const u = e.local.lastMousePos.x * t,
        c = (1 - e.local.lastMousePos.y) * s,
        p = Math.abs(i - u),
        m = Math.abs(r - c);
      return (
        (p < xe && m < xe) ||
          (n ? ((i = we(i, u, 2 * h)), (e.local.lastMousePos.x = i / t)) : (e.local.lastMousePos.x = 0.5),
          o ? ((r = we(r, c, 2 * h)), (e.local.lastMousePos.y = 1 - r / s)) : (e.local.lastMousePos.y = 0.5)),
        e.local.lastMousePos
      );
    }
    setEffectPlaneUniforms(e, t) {
      var s, i, r, a;
      let n = (null == (s = t.local.stateEffectProps) ? void 0 : s.speed) ?? t.speed ?? 1;
      if (
        (t.animating && e.uniforms.time && (e.uniforms.time.value += (60 * n) / this.fps),
        (null == (i = t.local.stateEffectProps) ? void 0 : i.playbackRate) &&
          e.videos.at(-1) &&
          (e.videos.at(-1).playbackRate = t.local.stateEffectProps.playbackRate),
        Re() && (null == (a = null == (r = this.interactivity) ? void 0 : r.mouse) ? void 0 : a.disableMobile))
      )
        return !1;
      ...
      o &&
        (e.uniforms.previousMousePos &&
          (this.mouse.ticks > 16
            ...
            : ((e.uniforms.previousMousePos.value.x = o.x), (e.uniforms.previousMousePos.value.y = o.y))),
        e.uniforms.mousePos &&
          !o.equals(e.uniforms.mousePos.value) &&
          ((e.uniforms.mousePos.value.x = o.x), (e.uniforms.mousePos.value.y = o.y)),
        this.mouse.ticks++);
    }
    getOrderedItems() {
      let e = [];
    ...
    getTextureParams(e, t, s) {
      ...
      const r = e[t];
      let a = 1;
      r.userData.downSample && (a = "number" == typeof r.userData.downSample ? r.userData.downSample : 0.5);
      return {
        maxWidth: this.curtain.canvas.width * a,
        maxHeight: this.curtain.canvas.height * a,
        depth: null == (i = null == s ? void 0 : s.data) ? void 0 : i.depth,
      };
    }
    handlePlaneCreation() {
      ((this.initialized = !0),
    ...
    waitForAssetsAndDisablePlanes() {
      this.layers.some(
        (e) =>
          ...
          Object.values(this.local.preloadedTextures).some((e) => e && null === e.texture),
      )
  ...
  function rt(e, t, s) {
    e.addEventListener(t, s, { passive: !0 });
  }
  function at(e, t, s) {
  ...
  function nt() {
    (rt(window, "scroll", Ke),
      Re() ? rt(window, "touchmove", tt) : rt(window, "mousemove", tt),
      rt(window, "routeChange", Ce),
      rt(document, "mouseleave", et),
      (he = (function (e, t) {
        let s;
        return function (...i) {
          (clearTimeout(s),
      ...
      Re() ? rt(window, "orientationchange", he) : rt(window, "resize", he),
      rt(document, ne, Ye),
      (le = !0));
  }
  function ot() {
    (at(window, "mousemove", tt),
      at(window, "touchmove", tt),
      at(window, "scroll", Ke),
      at(window, "routeChange", Ce),
      at(document, "mouseleave", et),
      he && (at(window, "resize", he), at(window, "orientationchange", he)),
      at(document, ne, Ye),
      (le = !1));
  }
  function ht(e) {
    let t = e.projectId ? e.projectId.split("?")[0] : null,
      s = e.projectId ? e.projectId.split("?")[1] : null;
        ...
        if (s) {
          ...
          if (e)
            try {
              ...
              return (null == t ? void 0 : t.options) && ((null == t ? void 0 : t.layers) || (null == t ? void 0 : t.history))
                ? Promise.resolve(t)
                : (i(new Error(`Did not find valid JSON inside ${s}`)), Promise.reject());
            } catch (n) {
              return (i(new Error(`Error parsing JSON from ${s}: ${n.message}`)), Promise.reject());
            }
        } else {
          let s = "https://storage.googleapis.com/unicornstudio-production";
          (r || (null == t ? void 0 : t.includes("production=true"))
            ? ((s = "https://assets.unicorn.studio"), (t = `v=${Date.now()}`))
            : (null == t ? void 0 : t.includes("update=")) || (t = `v=${Date.now()}`),
            (a = `${s}/embeds/${e}${t ? "?" + t : ""}`));
        }
        return fetch(a)
          .then((e) => e.json())
          .then((e) => e)
          .catch((e) => {});
      })(t, s, e.filePath, r, e.production)
        .then((s) => {
          (s && (s.layers || s.history) && s.options) || r(new Error(`Error fetching data for project id '${e.projectId}'`));
          const a = s.options || {},
            n =
              ((o = e.element),
              (
                "object" == typeof HTMLElement
                  ...
                  : o && "object" == typeof o && null !== o && 1 === o.nodeType && "string" == typeof o.nodeName
              )
                ? e.element
                : document.getElementById(e.elementId));
          var o;
          if (!n) return void r(new Error(`Couldn't find an element with id '${e.elementId}' on the page.`));
          const h = be();
          n.setAttribute("data-scene-id", h);
          let l = e.scale || a.scale || 1,
            d = e.dpi || a.dpi || Math.min(1.5, window.devicePixelRatio);
          const u = (function (e, t, s, i) {
              const r = i ? { ...s, modules: i } : s,
                a = [];
              return (
                e.forEach((e) => {
                  switch (e.layerType) {
                    case "text":
                      a.push(new Xe(e, t, r).unpackage());
                      break;
                    case "image":
                      a.push(new Ge(e, t, r).unpackage());
                      break;
                    case "model":
                      a.push(new je(e, t, r).unpackage());
                      break;
                    case "shape":
                      a.push(new We(e, t, r).unpackage());
                      break;
                    case "effect":
                      a.push(new He(e, t, r).unpackage());
                  }
                }),
                a
              );
          ...
          ((c.curtain.canvas.innerText = e.altText || ""),
            c.curtain.canvas.setAttribute("aria-label", e.ariaLabel || "Unicorn Studio Scene"),
            c.curtain.canvas.setAttribute("role", "img"));
          let p = a[ye("ZnJlZVBsYW4=")];
          ((p || a[ye("aW5jbHVkZUxvZ28=")]) &&
            (function (e, t) {
              const s = document.createElement("a");
              ((s.href = "https://unicorn.studio?utm_source=public-url"),
                (s.style =
              ...
              ((i.src = ye("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn")),
                (i.alt = ye("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
                (i.style = "width: 170px; height: auto;"),
                s.appendChild(i),
                t.appendChild(s));
            })(0, n),
            st.push(c),
            (c.layers = u),
            c.preloadTextures(),
            c.setInteractiveParams(e, a),
            (c.isInView = c.isFixed || $e(c.element, c.bbox, 50)),
  ...
  ((e.addScene = ht),
    ...
    (e.init = function () {
      return (function () {
        ...
        ? new Promise((e, t) => {
            const s = [...document.querySelectorAll("[data-us-project], [data-us-project-src]")],
              i = "undefined" != typeof window && window.requestIdleCallback ? window.requestIdleCallback : (e) => setTimeout(e, 0);
            s.filter((e) => !e.getAttribute("data-us-initialized")).forEach((t, r) => {
              (t.setAttribute("data-us-initialized", !0),
                i(() => {
                  const i = Ee(t, "data-us-project"),
                    a = Ee(t, "data-us-project-src"),
                    n = Ee(t, "data-us-disablemobile"),
                    o = Ee(t, "data-us-disablemouse");
                  ht({
                    projectId: a ? null : i,
                    filePath: a,
                    element: t,
                    dpi: +Ee(t, "data-us-dpi"),
                    scale: +Ee(t, "data-us-scale"),
                    production: Ee(t, "data-us-production"),
                    fps: +Ee(t, "data-us-fps"),
                    lazyLoad: Ee(t, "data-us-lazyload"),
                    altText: Ee(t, "data-us-alttext"),
                    ariaLabel: Ee(t, "data-us-arialabel"),
                    fixed: Ee(t, "data-us-fixed"),
                    interactivity: n || o ? { mouse: { disableMobile: n, disabled: o } } : null,
                  }).then((t) => {
                    r === s.length - 1 && e(st);
                  });
                }));
